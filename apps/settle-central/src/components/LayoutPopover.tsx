...
import { RadioGroup, RadioGroupItem } from "@thetis/ui/radio-group";
...
const LayoutPopover = () => {
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="end" side="bottom" className="p-3 w-[200px]">
        <RadioGroup value={view} onValueChange={(value) => setView(value as "table" | "cards")}>
