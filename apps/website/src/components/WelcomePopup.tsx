...
const WelcomePopup: React.FC<WelcomePopupProps> = ({
  ...
  return (
    ...
    >
      <div className="slide-in-from-bottom-4 relative bg-white dark:bg-neutral-900 shadow-2xl m-4 rounded-2xl w-full max-w-lg overflow-hidden animate-in duration-300 zoom-in-95">
        {/* Close button */}
        <button
          onClick={handleClose}
