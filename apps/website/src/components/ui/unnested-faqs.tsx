...
export default function UnnestedFAQs({ faqs, className = "px-4 md:px-0" }: UnnestedFAQsProps) {
  return (
    <Accordion className={className} type="single" collapsible>
      {faqs.map((faq) => (
        <AccordionItem className="last:border-b-0" key={faq.question} value={faq.question}>
