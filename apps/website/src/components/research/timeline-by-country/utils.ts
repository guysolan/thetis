...
export function getCountryById(countryId: string, countries: Country[]): Country | undefined {
...
export function getJourneyDataForStageAndCountry(
  ...
  return journeyData.find((data) => data.stageId === stageId && data.countryId === countryId);
}
...
export function groupJourneyDataByProperty(
  ...
  selectedCountries.forEach((countryId) => {
    const data = getJourneyDataForStageAndCountry(stageId, countryId, journeyData);
