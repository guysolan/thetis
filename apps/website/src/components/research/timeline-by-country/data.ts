...
export const journeyData: JourneyDataPoint[] = [
  // Injury
  {
    ...
    countryId: "usa",
    timing: "Day 0",
    description: "Sports/exertion; sudden 'pop' with pain. No equipment used.",
    clinicians: "Initially self-managed; may seek telehealth guidance from:",
  },
  {
    stageId: "injury",
    countryId: "canada",
  ...
  },
  {
    ...
    timing: "Day 0",
    description: "Sports/exertion; sudden 'pop' with pain. No equipment used.",
    clinicians: "Initially self-managed; may contact Hausarzt (family doctor)",
  },
  {
    stageId: "injury",
    countryId: "france",
    timing: "Day 0",
    description: "Sports/exertion; sudden 'pop' with pain. No equipment used.",
    clinicians: "Initially self-managed; may contact médecin traitant (primary care doctor)",
  },
  ...
  },
  {
    ...
    clinicians: "Emergency physicians, family physicians, or nurse practitioners.",
  },
  {
    stageId: "initial-evaluation",
    countryId: "australia",
  ...
  },
  {
    ...
    clinicians: "Emergency physicians or GPs. Sometimes direct referral to orthopedic specialists.",
  },
  ...
  // Imaging
  {
    ...
    clinicians: "Radiologists interpret imaging. Orthopedic surgeons review results.",
  },
  {
    stageId: "imaging",
    countryId: "canada",
  ...
  },
  {
    ...
    description: "Ultrasound preferred (75% of cases); MRI for complex cases (25% of cases).",
    clinicians: "Radiologists and sonographers perform and interpret imaging.",
  },
  {
    stageId: "imaging",
    countryId: "uk",
    ...
    clinicians: "Radiologists and sonographers. NHS wait times vary significantly by region.",
  },
  {
    stageId: "imaging",
    countryId: "germany",
    timing: "Usually within 1-5 days.",
    description: "Ultrasound is standard (70% of cases); MRI for complex cases (30% of cases).",
    clinicians: "Radiologists (Radiologen) work closely with orthopedic specialists.",
  },
  {
    stageId: "imaging",
    countryId: "france",
  ...
  // Specialist
  {
    ...
    description: "Consultation with orthopedic surgeon or sports medicine specialist.",
    clinicians:
  ...
  },
  {
    ...
    description: "Referral to orthopedic surgeon for assessment and treatment planning.",
    clinicians: "Orthopedic surgeons, often with foot/ankle specialization.",
  },
  {
    stageId: "specialist",
    countryId: "australia",
    ...
    clinicians: "Orthopedic surgeons, often with sports medicine or foot/ankle specialization.",
  },
  {
    stageId: "specialist",
    countryId: "uk",
  ...
  },
  {
    ...
    description: "Consultation with orthopedic surgeon for treatment planning.",
    clinicians:
  ...
  // Surgery
  {
    ...
    description: "Minimally invasive techniques growing in popularity (~30-40% of cases).",
    equipment: "Outpatient procedure with regional or general anesthesia.",
    clinicians: "Orthopedic surgeons or podiatric surgeons (DPMs) perform the procedure.",
  },
  {
    stageId: "surgery",
    countryId: "canada",
    ...
    equipment: "Typically inpatient with overnight stay; regional or general anesthesia.",
    clinicians: "Orthopedic surgeons perform the procedure.",
  },
  {
    stageId: "surgery",
    countryId: "australia",
    timing: "Within 1-2 weeks in private system; 2-4 weeks in public system.",
    description: "Mix of open (~70%) and minimally invasive (~30%) techniques.",
    equipment: "Often outpatient procedure; some cases require overnight stay.",
    clinicians: "Orthopedic surgeons perform the procedure.",
  },
  {
    stageId: "surgery",
    ...
    equipment: "Often day surgery with regional anesthesia; some cases require overnight stay.",
    clinicians: "Orthopedic consultants or specialized foot/ankle surgeons perform the procedure.",
  },
  {
    stageId: "surgery",
    countryId: "germany",
    timing: "Usually within 1 week of decision.",
    description: "Mix of techniques with growing adoption of minimally invasive approaches (~40%).",
    equipment: "Often inpatient with 2-3 day stay; regional or general anesthesia.",
    clinicians: "Orthopedic specialists or trauma surgeons perform the procedure.",
  },
  {
    stageId: "surgery",
    countryId: "france",
    ...
    equipment: "Typically inpatient with 1-2 day stay; regional or general anesthesia.",
    clinicians: "Orthopedic surgeons perform the procedure.",
  },
  ...
  // Immobilization & Rehab
  {
    ...
    clinicians: "Physical therapists lead rehabilitation with regular orthopedic follow-up.",
  },
  {
    stageId: "immobilization",
    countryId: "canada",
    ...
    clinicians: "Physiotherapists manage rehabilitation with periodic orthopedic follow-up.",
  },
  {
    stageId: "immobilization",
    countryId: "australia",
    ...
    equipment: "Removable boot with adjustable heel wedges. ~15% still use plaster initially.",
    clinicians: "Physiotherapists lead rehabilitation with orthopedic follow-up at key milestones.",
  },
  {
    stageId: "immobilization",
    countryId: "uk",
    timing: "Week 0-12",
    description: "Early weight-bearing in ~75% of centers following UK STAR trial influence.",
    equipment:
  ...
  },
  {
    ...
    clinicians: "Kinésithérapeutes lead rehabilitation with regular orthopedic follow-up.",
  },
  ...
  },
  {
    ...
    equipment: "Supportive footwear. ~40% use compression garments during activity.",
  ...
  },
  {
    ...
    equipment: "Supportive footwear. ~20% use compression sleeves during high-impact activities.",
    clinicians:
  ...
  },
  {
    ...
    equipment: "Supportive footwear. ~35% use compression garments during initial return.",
    clinicians:
