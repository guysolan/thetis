...
import { ArrowRight, Check, Loader2, ShoppingBag, Sparkles, X } from "lucide-react";
...
export function CheckoutUpsell({ onContinueToCheckout, onClose }: CheckoutUpsellProps) {
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex justify-between items-center mt-3">
                        ...
                        {isAdded ? (
                          ...
                          <Button
                            size="sm"
                            onClick={() => handleAddItem(product.variantId)}
