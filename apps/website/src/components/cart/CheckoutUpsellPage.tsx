...
export function CheckoutUpsellPage() {
  ...
  const primaryUpsell = upsellSuggestions.length > 0 ? upsellSuggestions[0] : null;
  const isSplintUpsell = primaryUpsell ? primaryUpsell.variantId.includes("47494539") : false; // Splint variant IDs start with this
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto max-w-xl text-neutral-600 dark:text-neutral-400 text-lg">
            Review your items below and add any additional products before checkout.
          </p>
        </div>
        ...
        <div className="space-y-3 mb-8">
          ...
          {cartLines.map((line) => {
            const lineTotal = (parseFloat(line.merchandise.price.amount) * line.quantity).toFixed(
              2,
            );
            const variantTitle =
          ...
          <div className="mb-8">
            ...
            <div className="space-y-4">
              {upsellSuggestions.map((product) => {
                const isAdded = addedItems.includes(product.variantId);
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex justify-between items-center">
            ...
            {isAdded ? (
              ...
              <Button size="default" onClick={onAdd} disabled={isAdding || !product.canAddToCart}>
                {isAdding ? <Loader2 className="mr-2 w-4 h-4 animate-spin" /> : null}
                Add to Order
              </Button>
            )}
          </div>
