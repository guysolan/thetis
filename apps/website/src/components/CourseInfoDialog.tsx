...
export function CourseInfoDialog({ open, onOpenChange, courseType }: CourseInfoDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white dark:bg-neutral-800 max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <DialogTitle className="mb-2 text-2xl md:text-3xl">{course.title}</DialogTitle>
              ...
              <div className="mt-4">
                ...
                <span className="ml-2 text-neutral-500 dark:text-neutral-400">one-time</span>
              </div>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-6 mt-6">
          ...
          {courseType === "standard" && "whatYoullLearn" in course && course.whatYoullLearn && (
            <div>
              <h3 className="mb-4 font-semibold text-neutral-900 dark:text-neutral-100 text-lg">
                What You'll Learn
              </h3>
