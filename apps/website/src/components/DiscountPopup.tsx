...
export function DiscountPopup({ onEmailSubmit }: DiscountPopupProps) {
      ...
      <DialogContent className="sm:max-w-md">
        {isSubmitted ? (
          <div className="py-6 text-center">
            ...
            <h3 className="mb-2 font-semibold text-neutral-900 text-lg">Check your email!</h3>
            <p className="text-neutral-500 text-sm">Your 10% discount code is on its way.</p>
          </div>
        ) : (
          <>
            <DialogHeader>
            ...
            <form onSubmit={handleDiscountSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={isSubmitting || !email}>
                {isSubmitting ? "Saving..." : "Get My 10% Discount"}
              </Button>
