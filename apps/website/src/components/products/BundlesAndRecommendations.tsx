...
export function BundlesAndRecommendations({ lang = "en" }: BundlesAndRecommendationsProps) {
  const t = lang in content ? content[lang as keyof typeof content] : content.en;
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-4 bg-white dark:bg-neutral-800 p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg">
            ...
            <Button
              size="sm"
              variant="outline"
              onClick={() => handleAddToCart("gid://shopify/ProductVariant/52265314353480")}
              disabled={isAdding === "gid://shopify/ProductVariant/52265314353480"}
              className="shrink-0"
            >
              {isAdding === "gid://shopify/ProductVariant/52265314353480" ? (
        ...
        <div className="flex justify-between items-center">
          <div>
            {splintPriceLoading || coursePriceLoading ? (
              ...
              <span className="font-bold text-neutral-900 dark:text-neutral-100 text-xl">—</span>
            )}
          </div>
          <Button
            size="sm"
            onClick={() => {
              // Add both to cart
              handleAddToCart("gid://shopify/ProductVariant/47494539673928");
              setTimeout(() => {
                handleAddToCart("gid://shopify/ProductVariant/52265314353480");
              }, 500);
            }}
            disabled={!!isAdding}
            className="shrink-0"
