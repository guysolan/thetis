...
const content = {
  ...
  de: {
    ...
    message:
      "Je früher Sie bestellen, desto mehr komfortable Nächte haben Sie während der Genesung",
  ...
  fr: {
    ...
    message:
      "Plus vous commandez tôt, plus vous aurez de nuits confortables pendant la récupération",
...
const UrgencyMessage: React.FC<UrgencyMessageProps> = ({
  ...
  if (variant === "compact") {
    return (
      <div className={cn("flex items-center gap-2 text-amber-700 dark:text-amber-400", className)}>
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-amber-800 dark:text-amber-200 text-sm">{t.message}</p>
