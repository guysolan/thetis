...
export const patients: Review[] = [
  ...
  },
  {
    ...
    body: "It was extremely difficult getting any sleep whilst wearing a heavy boot. I found the splint on line and bought it without reference to any of the professionals. It made a massive difference to getting a good nights rest. I would recommend it to anyone with a ruptured Achilles tendon.",
  },
  {
    date: "2024-03-15",
    stars: 5,
  ...
  },
  {
    ...
    body: "Finally got the restful sleep I needed. The cast and heavy dirty boot made sleep tough. If you're recovering from an achilles rupture buy this immediately.",
  },
  {
    country: "US",
    is_pinned: false,
    ...
    body: "Although this splint is intended for night use only. I used it day and night for immobilization in my first 4 weeks after Achilles repair. I used this to replace the slab my surgeon put me on after surgery. Its convenient, comfortable, well ventilated whilst providing adequate support to put my ankle in place. I certainly recommend this product over cast or slab after achilles repair if the surgeon prefers non weight bearing early post op.",
    short:
  ...
  },
  {
    ...
    body: "Works great to keep the achilles tendon in relaxed state when recovering from a achilles injury or post-op. It literally takes a few secs to put on and remove. I've been using it for a couple of weeks now and its working well. I take my boots off for the night and wear this while sleeping. Its comfortable as well. Highly recommend if you are in the recovery stage of an achilles rupture post-op and out of the cast.",
    short:
  ...
  },
  {
    ...
    name: "Brandon",
    title: "Life Saver!",
    body: "This worked great and kept me from having to wear my big clunky walking boot to bed! So glad I found this. I couldn't sleep with that walking boot at night!! Great product.",
  },
  {
    country: "US",
    date: "2024-11-12",
  ...
  },
  {
    ...
    body: "Nach der OP an der Achillessehne war diese Schiene eine Erleichterung in der Nacht! Würde ich auf alle Fälle empfehlen wenn man wieder durchschlafen möchte!",
  },
  {
    date: "2024-05-23",
    stars: 5,
  ...
  },
  {
    ...
    body: "After surgery and post op week 2 when the splint was removed, had a horrible night sleep with the splint. Went and bought this. Expensive but man did it help. Also was able to wear it while sitting and doing work as long as I don't step down. Boot was to tiring for it to be comfortable all day.",
  },
  {
    date: "2023-05-24",
    stars: 5,
    ...
    body: "This splint has proved the difference between a good nights sleep and barely any sleep at all. Wearing it at other odd times that boot is inconvenient also gives me confidence that I won't unexpectedly pull my foot upwards.",
  },
  {
    date: "2024-02-06",
    stars: 5,
    ...
    name: "Az",
    title: "Superb",
    body: "Really useful after my dreadful Achilles tendon tear when I didn't want to wear the boot in bed!",
  },
  {
    date: "2024-05-24",
    stars: 5,
    ...
    name: "Rem",
    title: "A Must",
    body: "This boot was an excellent buy. I have a ruptured Achilles and this allows me to remove the big boot on occasion, just make sure you keep your toes forward during transition, someone to help would be an advantage too. Would recommend, but as the product states, 'only for a ruptured Achilles.'",
  },
  {
    is_pinned: true,
    date: "2022-05-15",
    ...
    body: "This is a saviour for night time wearing. So much easier than the big boot. You need to be careful of getting up. I started using a crutch initially but as confidence grew just tried to ensure that I was careful. Five weeks down and another five or six to go. Would have struggled with the full boot.",
    short:
  ...
  },
  {
    ...
    body: "A great alternative to wearing the walking boot to bed, without worrying about inadvertently straightening or knocking your foot.",
  },
  {
    country: "GB",
    ...
    body: "Bring summer I was finding that big boot for protecting my leg too hot. I got approval from a Dr that using this when sleep from week 4 would be fine. It has made such a difference!",
  },
  {
    country: "GB",
    is_pinned: true,
    ...
    body: "Brilliant device. Arrived the day after it was ordered. Delighted in all respects.",
  },
  {
    country: "GB",
    is_pinned: true,
    ...
    body: "This product is well designed. It gives good protection to injured Achilles' tendon whilst sleeping. Allows much better sleep compared to the pressure boot.",
  },
  {
    country: "GB",
    ...
    body: "This is a great idea, wasn't looking forward too keeping the aircast boot on all day and night.",
  },
  {
    country: "GB",
    ...
    body: "This item saved me from going crazy with a boot following my operation to fix my leg.",
  },
  {
    country: "GB",
    ...
    body: "I'm glad my consultant recommended this as it makes sleeping much easier.",
  },
  {
    country: "GB",
    date: "2022-05-17",
