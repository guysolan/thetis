...
export const athletes: Review[] = [
  ...
  },
  {
    ...
    image: OliviaBlatch,
    title: "Slimmer, lightweight, and allows free movement while protecting the tendon",
    short: "Slimmer, lightweight, and allows free movement while protecting the tendon",
    body: "The Thetis Splint is a lot slimmer and far more lightweight than the orthopaedic boot I was sleeping in. It allows me to move my leg more freely but still stops me from flexing my toes beyond a certain point, which is ideal whilst the tendon heals. The splint even comes in my favourite colour, so I was sold the minute I saw it!",
    country: "GB",
    link: "",
    clinics: [],
    clinicImages: [],
