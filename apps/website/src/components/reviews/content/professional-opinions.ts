...
const professionalOpinionsContent: Record<
  Lang,
  {
...
export const translatedClinicians: TranslatedReview[] = [
  {
    ...
    content: {
      en: {
        ...
        title: "A fantastic alternative to uncomfortable hospital boots for night wear",
        short:
        ...
        body: "When I tore my own Achilles tendon, the hardest part of the recovery was having to wear the hospital boot in bed at night for many weeks. My only option was to make myself a splint using plaster-cast materials and make-shift straps. It is fantastic that Thetis Medical have produced this night-splint. It is certain to improve the recovery experience for patients.",
      },
      de: {
        description: "Ehemaliger Präsident der British Orthopaedic Foot and Ankle Society",
        title: "Eine fantastische Alternative zu unbequemen Krankenhausstiefeln für die Nacht",
        short:
      ...
      fr: {
        description: "Ancien président de la British Orthopaedic Foot and Ankle Society",
        title: "Une alternative fantastique aux bottes d'hôpital inconfortables pour la nuit",
        short:
  ...
  },
  {
    ...
    content: {
      en: {
        ...
        body: "I've been recommending the Thetis night time splint for all my ruptured Achilles patients for two years now. It is worth every penny as it stops the misery of trying to get good nights sleep in an uncomfortable boot !",
      },
      de: {
        description: "Fuß- und Sprunggelenkchirurg",
        ...
        body: "Ich empfehle die Thetis-Nachtschiene seit zwei Jahren allen meinen Patienten mit Achillessehnenriss. Sie ist jeden Cent wert, da sie das Elend beendet, in einem unbequemen Stiefel eine gute Nachtruhe zu finden!",
      },
      fr: {
        description: "Chirurgien du pied et de la cheville",
        ...
        body: "Je recommande l'attelle de nuit Thetis à tous mes patients ayant une rupture d'Achille depuis deux ans maintenant. Elle vaut chaque centime car elle met fin à la misère d'essayer de passer une bonne nuit de sommeil dans une botte inconfortable !",
      },
      es: {
        description: "Cirujano de pie y tobillo",
        ...
        body: "He estado recomendando la férula nocturna Thetis a todos mis pacientes con ruptura de Aquiles desde hace dos años. ¡Vale cada centavo ya que detiene la miseria de tratar de dormir bien por la noche con una bota incómoda!",
      },
      it: {
        description: "Chirurgo del piede e della caviglia",
        ...
        body: "Raccomando la férula notturna Thetis a tutti i miei pazienti con rottura di Achille da due anni ormai. Vale ogni centesimo perché ferma la miseria di cercare di dormire bene la notte con una bota scomoda!",
      },
    },
  },
  {
    ...
    content: {
      en: {
        ...
        body: "Thetis night-time splint are excellent tools for enhancing recovery and patient comfort. My patients have had a very positive experience. Lightweight and effective, it provide relief during sleep and protect the foot outside the boot. Highly recommended to improve compliance and recovery outcomes.",
      },
      de: {
        description: "Fuß- und Sprunggelenkchirurg",
        title: "Ausgezeichnetes Werkzeug zur Verbesserung der Genesung und des Komforts",
        short:
          "Leicht und effektiv, bietet es Linderung im Schlaf und schützt den Fuß außerhalb des Stiefels.",
        body: "Die Thetis-Nachtschiene ist ein ausgezeichnetes Werkzeug zur Verbesserung der Genesung und des Patientenkomforts. Meine Patienten haben sehr positive Erfahrungen gemacht. Leicht und effektiv, bietet sie Linderung im Schlaf und schützt den Fuß außerhalb des Stiefels. Sehr zu empfehlen, um die Compliance und die Genesungsergebnisse zu verbessern.",
      },
      fr: {
        description: "Chirurgien du pied et de la cheville",
        title: "Excellent outil pour améliorer la récupération et le confort",
        short:
          "Léger et efficace, il soulage pendant le sommeil et protège le pied en dehors de la botte.",
        body: "L'attelle de nuit Thetis est un excellent outil pour améliorer la récupération et le confort du patient. Mes patients ont eu une expérience très positive. Léger et efficace, il soulage pendant le sommeil et protège le pied en dehors de la botte. Fortement recommandé pour améliorer l'observance et les résultats de la récupération.",
      },
      es: {
        description: "Cirujano de pie y tobillo",
        title: "Excelente herramienta para mejorar la recuperación y la comodidad",
        short:
          "Ligero y eficaz, proporciona alivio durante el sueño y protege el pie fuera de la bota.",
        body: "La férula nocturna Thetis es una excelente herramienta para mejorar la recuperación y la comodidad del paciente. Mis pacientes han tenido una experiencia muy positiva. Ligero y eficaz, proporciona alivio durante el sueño y protege el pie fuera de la bota. Muy recomendable para mejorar el cumplimiento y los resultados de la recuperación.",
      },
      it: {
        description: "Chirurgien du pied et de la cheville",
        title: "Ottimo strumento per migliorare la riabilitazione e il comfort",
  ...
  },
  {
    ...
    content: {
      en: {
        ...
        body: "I came across this device, not too long ago and feel it has really helped my patients recover from Achilles tendon ruptures. Makes complete sense to use something like this and I highly recommend this product. Comfort and usability all round.",
      },
      de: {
        description: "Fuß- und Sprunggelenkchirurg",
      ...
      fr: {
        ...
        body: "J'ai découvert cet appareil il n'y a pas si longtemps et j'ai l'impression qu'il a vraiment aidé mes patients à se remettre de ruptures du tendon d'Achille. Il est tout à fait logique d'utiliser quelque chose comme ça et je recommande vivement ce produit. Confort et facilité d'utilisation.",
      },
      es: {
        description: "Cirujano de pie y tobillo",
        ...
        body: "Me encontré con este dispositivo no hace mucho tiempo y siento que realmente ha ayudado a mis pacientes a recuperarse de las roturas del tendón de Aquiles. Tiene mucho sentido usar algo como esto y recomiendo encarecidamente este producto. Comodidad y facilidad de uso en todos los sentidos.",
      },
      it: {
        description: "Chirurgo del piede e della caviglia",
        ...
        body: "Mi sono imbattuto in questo dispositivo non molto tempo fa e sento che ha davvero aiutato i miei pazienti a riprendersi dalle rotture del tendine di Achille. Ha perfettamente senso usare qualcosa del genere e raccomando vivamente questo prodotto. Comfort e usabilità a tutto tondo.",
      },
    },
  },
];
