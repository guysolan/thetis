...
const translations = {
    en: {
        ...
        videoApprovalMsg: "We'll review your submission within 3-5 business days. If your video includes a spoken review (10+ seconds), you'll receive an email with instructions to claim your",
        cashback: "cashback",
        ...
        noMediaThankYou: "Thank you for your feedback! To earn cashback, make sure to include a video with spoken review (10+ seconds) in future submissions.",
    ...
    de: {
        ...
        min10sec: "(mindestens 10 Sekunden Sprechen). Nur-Foto-Bewertungen qualifizieren nicht für Cashback.",
        ...
        uploadFormats: "Fotos: JPG, PNG • Videos: MP4, MOV (10+ Sek. für Cashback) • Max 100MB pro Datei",
        ...
        videoApprovalMsg: "Wir werden Ihre Einreichung innerhalb von 3-5 Werktagen prüfen. Wenn Ihr Video eine gesprochene Bewertung (10+ Sekunden) enthält, erhalten Sie eine E-Mail mit Anweisungen zur Anforderung Ihres",
        cashback: "Cashbacks",
        ...
        noMediaThankYou: "Vielen Dank für Ihr Feedback! Um Cashback zu verdienen, fügen Sie bei zukünftigen Einreichungen ein Video mit gesprochener Bewertung (10+ Sekunden) hinzu.",
    ...
    fr: {
        ...
        min10sec: "(minimum 10 secondes de parole). Les avis avec photos uniquement ne donnent pas droit au cashback.",
        ...
        uploadFormats: "Photos : JPG, PNG • Vidéos : MP4, MOV (10+ sec pour cashback) • Max 100Mo chacun",
        ...
        videoApprovalMsg: "Nous examinerons votre soumission dans les 3 à 5 jours ouvrables. Si votre vidéo comprend un avis parlé (10+ secondes), vous recevrez un email avec les instructions pour réclamer votre",
        cashback: "cashback",
        ...
        noMediaThankYou: "Merci pour vos commentaires ! Pour gagner du cashback, assurez-vous d'inclure une vidéo avec un avis parlé (10+ secondes) dans vos futures soumissions.",
    ...
    es: {
        ...
        min10sec: "(mínimo 10 segundos hablando). Las reseñas solo con fotos no califican para cashback.",
        ...
        uploadFormats: "Fotos: JPG, PNG • Videos: MP4, MOV (10+ seg para cashback) • Máx 100MB cada uno",
        ...
        videoApprovalMsg: "Revisaremos tu envío dentro de 3-5 días hábiles. Si tu video incluye una reseña hablada (10+ segundos), recibirás un email con instrucciones para reclamar tu",
        cashback: "cashback",
        ...
        noMediaThankYou: "¡Gracias por tus comentarios! Para ganar cashback, asegúrate de incluir un video con reseña hablada (10+ segundos) en futuros envíos.",
    ...
    it: {
        ...
        min10sec: "(minimo 10 secondi di parlato). Le recensioni solo con foto non danno diritto al cashback.",
        ...
        videoApprovalMsg: "Esamineremo il tuo invio entro 3-5 giorni lavorativi. Se il tuo video include una recensione parlata (10+ secondi), riceverai un'email con le istruzioni per richiedere il tuo",
        cashback: "cashback",
        ...
        noMediaThankYou: "Grazie per il tuo feedback! Per guadagnare cashback, assicurati di includere un video con recensione parlata (10+ secondi) nei futuri invii.",
