...
const faqContent: Record<Lang, { question: string; answer: string }[]> = {
  en: [
    ...
    {
      question: "How does the night splint keep my Achilles safe while sleeping?",
      answer:
  ...
  de: [
    {
      question: "Kann ich ohne meinen Stiefel nach einer Achillessehnenruptur schlafen?",
      answer:
    ...
    {
      question: "Wie hält die Nachtschiene meine Achillessehne während des Schlafes sicher?",
      answer:
    ...
    {
      question: "Kann ich dies nachts anstelle meines Stiefels verwenden?",
      answer:
  ...
  fr: [
    {
      question: "Puis-je dormir sans ma botte après une rupture du tendon d'Achille?",
      answer:
    ...
    {
      question: "L'attelle de nuit est-elle meilleure que dormir dans ma botte?",
      answer:
    ...
    {
      question: "Vais-je me réveiller si je bouge mon pied de la mauvaise façon?",
      answer:
  ...
  es: [
    {
      question: "¿Puedo dormir sin mi bota después de la rotura del tendón de Aquiles?",
      answer:
    ...
    {
      question: "¿Cómo mantiene la férula nocturna mi Aquiles seguro mientras duermo?",
      answer:
  ...
  it: [
    {
      question: "Posso dormire senza il mio stivale dopo la rottura del tendine d'Achille?",
      answer:
    ...
    {
      question: "Come fa la stecca notturna a mantenere il mio Achille al sicuro mentre dormo?",
      answer:
    ...
    {
      question: "La stecca notturna è meglio che dormire nel mio stivale?",
      answer:
