    ...
    <div className="md:p-12">
      <div className="flex lg:flex-row flex-col items-center gap-8">
        ...
        <div className="flex-1">
          ...
          <p className="mb-6 font-semibold text-neutral-700 text-lg">The only safe solution:</p>
          ...
          <div className="space-y-3 mb-6">
            <div className="flex items-center gap-3">
              ...
              <p className="font-semibold text-neutral-900">Trusted by surgeons</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex flex-shrink-0 justify-center items-center bg-primary/10 rounded-full w-8 h-8">
                <span className="font-bold text-primary">✓</span>
              </div>
              <p className="font-semibold text-neutral-900">Loved by 5000+ patients</p>
            </div>
          </div>
