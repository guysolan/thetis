...
const faqContent: Record<Lang, { question: string; answer: string }[]> = {
  ...
  de: [
    {
      question: "Welche Produkte brauche ich für die Achillessehnenruptur-Erholung?",
      answer:
    ...
    {
      question: "Wie unterscheidet sich die Thetis-Nachtschiene von einem Gehstiefel?",
      answer:
  ...
  fr: [
    {
      question: "De quels produits ai-je besoin pour la récupération de la rupture d'Achille?",
      answer:
    ...
    {
      question: "En quoi l'attelle de nuit Thetis est-elle différente d'une botte de marche ?",
      answer:
    ...
    {
      question: "Qu'est-ce qui rend les produits Thetis Medical différents?",
      answer:
  ...
  es: [
    {
      question: "¿Qué productos necesito para la recuperación de la rotura de Aquiles?",
      answer:
    ...
    {
      question: "¿En qué se diferencia la férula nocturna Thetis de una bota de caminar?",
      answer:
  ...
  it: [
    {
      question: "Di quali prodotti ho bisogno per il recupero dalla rottura dell'Achille?",
      answer:
    ...
    {
      question: "In cosa è diversa la stecca notturna Thetis da uno stivale da passeggio?",
      answer:
