    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: (
            <>
              Yes, it is designed for complete Achilles tears. For more information go to{" "}
              <a
  ...
  de: [
    {
      ...
      questions: [
        ...
        {
          question: "Mein Fuß kann sich seitwärts bewegen, ist das ein Problem?",
          answer:
    ...
    },
    {
      ...
      questions: [
        {
          question: "Kann ich diese anstelle eines Stiefels tagsüber tragen?",
          answer:
        ...
        {
          question: "Kann man die Schiene bei einer Achillessehnenentzündung verwenden?",
          answer:
        ...
        {
          question: "Kann ich die Schiene nass machen (Dusche/Schwimmen)?",
          answer:
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: "Wie hält die Schiene die korrekte Heilungsposition aufrecht?",
          answer:
        ...
        {
          question: "Kann ich dies bei einem kompletten Achillessehnenriss verwenden?",
          answer: (
            <>
              Ja, sie ist für komplette Achillessehnenrisse ausgelegt. Für weitere Informationen
              gehen Sie zu{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="https://thetismedical.com/achilles-ruptures"
        ...
        {
          question: "Wie ist das im Vergleich zum Tragen eines Stiefels in der Nacht?",
          answer:
        ...
        {
          question: "Ist eine gewisse seitliche Bewegung in der Schiene normal?",
          answer:
      ...
      questions: [
        {
          ...
          answer: (
            <>
              Wir versenden in die USA und nach Großbritannien, für Bestellungen in andere Länder
              besuchen Sie bitte
              <a
                className="text-primary underline underline-offset-2"
                href="https://thetismedical.com/partners"
        ...
        {
          question: "Wann werden ausverkaufte Größen wieder verfügbar sein?",
          answer: (
            <>
              Unsere Schiene ist beliebt, daher füllen wir unseren Lagerbestand ständig auf.
              Kontaktieren Sie{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="mailto:info@thetismedical.com"
  ...
  fr: [
    {
      ...
      questions: [
        ...
        {
          question: "Mon pied peut bouger sur le côté, est-ce un problème ?",
          answer:
    ...
    },
    {
      ...
      questions: [
        {
          question: "Puis-je porter cela à la place d'une botte pendant la journée ?",
          answer:
        ...
        {
          question: "Peut-on utiliser l'attelle pour une tendinite d'Achille ?",
          answer:
    ...
    },
    {
      ...
      questions: [
        {
          question: "À quel stade de la récupération dois-je commencer à utiliser l'attelle ?",
          answer:
        ...
        {
          question: "Comment l'attelle maintient-elle la position de guérison correcte ?",
          answer:
        ...
        {
          question: "Puis-je l'utiliser avec une déchirure complète du tendon d'Achille ?",
          answer: (
            <>
              Oui, elle est conçue pour les déchirures complètes du tendon d'Achille. Pour plus
              d'informations, allez{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="https://thetismedical.com/achilles-ruptures"
              >
        ...
        {
          question: "Comment cela se compare-t-il au port d'une botte la nuit ?",
          answer:
        ...
        {
          question: "Un certain mouvement de va-et-vient dans l'attelle est-il normal ?",
          answer:
      ...
      questions: [
        {
          ...
          answer: (
            <>
              Nous expédions aux États-Unis et au Royaume-Uni, pour les commandes dans d'autres
        ...
        {
          question: "Quand les tailles en rupture de stock seront-elles disponibles ?",
          answer: (
            <>
              Notre attelle est populaire, nous la réapprovisionnons donc constamment. Contactez{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="mailto:info@thetismedical.com"
              >
  ...
  es: [
    {
      ...
      questions: [
        ...
        {
          question: "Mi pie puede moverse hacia los lados, ¿es un problema?",
          answer:
    ...
    },
    {
      ...
      questions: [
        {
          question: "¿Puedo usar esto en lugar de una bota durante el día?",
          answer:
        ...
        {
          question: "¿Se puede usar la férula para la tendinitis de Aquiles?",
          answer:
    ...
    },
    {
      ...
      questions: [
        {
          question: "¿En qué etapa de la recuperación debo comenzar a usar la férula?",
          answer:
        ...
        {
          question: "¿Cómo mantiene la férula la posición de curación correcta?",
          answer:
        ...
        {
          question: "¿Puedo usar esto con un desgarro completo de Aquiles?",
          answer: (
            <>
              Sí, está diseñado para desgarros completos de Aquiles. Para más información, vaya{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="https://thetismedical.com/achilles-ruptures"
              >
        ...
        {
          question: "¿Cómo se compara esto con usar una bota por la noche?",
          answer:
        ...
        {
          question: "¿Es normal un poco de movimiento de lado a lado en la férula?",
          answer:
      ...
      questions: [
        {
          ...
          answer: (
            <>
              Enviamos a los EE. UU. y al Reino Unido, para pedidos en otros países, visite
              <a
                className="text-primary underline underline-offset-2"
                href="https://thetismedical.com/partners"
              >
        ...
        {
          question: "¿Cuándo estarán disponibles las tallas agotadas?",
          answer: (
            <>
              Nuestra férula es popular, por lo que siempre estamos reabasteciendo. Póngase en
              contacto con{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="mailto:info@thetismedical.com"
  ...
  it: [
    {
      ...
      questions: [
        ...
        {
          question: "Il mio piede può muoversi lateralmente, è un problema?",
          answer:
    ...
    },
    {
      ...
      questions: [
        {
          question: "Posso indossare questo invece di una borsa durante il giorno?",
          answer:
        ...
        {
          question: "Posso usare il tutore per la tendinite di Achille?",
          answer:
    ...
    },
    {
      ...
      questions: [
        {
          question: "In quale fase di recupero dovrei iniziare a usare il tutore?",
          answer:
        ...
        {
          question: "Come mantiene il tutore la corretta posizione di guarigione?",
          answer:
        ...
        {
          question: "Posso usare questo con una rottura completa del tendine di Achille?",
          answer: (
            <>
              Sì, è progettato per rotture complete del tendine di Achille. Per ulteriori
              informazioni, vai{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="https://thetismedical.com/achilles-ruptures"
        ...
        {
          question: "Come si confronta questo con l'uso di una borsa di notte?",
          answer:
        ...
        {
          question: "È normale un certo movimento laterale nel tutore?",
          answer:
      ...
      questions: [
        {
          ...
          answer: (
            <>
              Spediamo negli Stati Uniti e nel Regno Unito; per ordini in altri paesi, visita{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="https://thetismedical.com/partners"
              >
        ...
        },
        {
          ...
          answer: (
            <>
              Il nostro tutore è popolare, quindi lo stiamo sempre riassortendo. Contatta{" "}
              <a
                className="text-primary underline underline-offset-2"
                href="mailto:info@thetismedical.com"
              >
