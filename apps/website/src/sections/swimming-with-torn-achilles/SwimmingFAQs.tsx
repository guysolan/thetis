...
const faqContent: Record<Lang, { question: string; answer: string }[]> = {
  ...
  de: [
    ...
    {
      question: "Ist Schwimmen gut für die Achillessehnenruptur-Erholung?",
      answer:
    ...
    {
      question: "Wann kann ich nach einer Achillessehnenruptur mit dem Schwimmen beginnen?",
      answer:
  ...
  fr: [
    ...
    {
      question: "La natation est-elle bonne pour la récupération de la rupture d'Achille?",
      answer:
    ...
    {
      question: "Quand puis-je commencer à nager après une rupture d'Achille?",
      answer:
    ...
    {
      question: "Puis-je faire de la thérapie aquatique avec cette attelle?",
      answer:
  ...
  es: [
    ...
    {
      question: "¿Es buena la natación para la recuperación de la rotura de Aquiles?",
      answer:
    ...
    {
      question: "¿Cuándo puedo empezar a nadar después de una rotura de Aquiles?",
      answer:
  ...
  it: [
    ...
    {
      question: "Il nuoto è buono per il recupero dalla rottura dell'Achille?",
      answer:
    ...
    {
      question: "Quando posso iniziare a nuotare dopo una rottura dell'Achille?",
      answer:
