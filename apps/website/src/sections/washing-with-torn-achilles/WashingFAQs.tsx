...
const faqContent: Record<Lang, { question: string; answer: string }[]> = {
  ...
  de: [
    ...
    {
      question: "Kann ich meinen Fuß mit der Schiene tatsächlich reinigen?",
      answer:
  ...
  fr: [
    {
      question: "Puis-je me doucher avec une rupture du tendon d'Achille?",
      answer:
  ...
  it: [
    {
      question: "Posso fare la doccia con una rottura del tendine d'Achille?",
      answer:
