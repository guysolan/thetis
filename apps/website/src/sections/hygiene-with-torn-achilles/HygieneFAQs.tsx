...
const faqContent: Record<Lang, { question: string; answer: string }[]> = {
  ...
  de: [
    {
      question: "Wie halte ich mein Bett mit Achillessehnenruptur sauber?",
      answer:
    ...
    {
      question: "Ist die Schiene hygienischer als im Stiefel zu schlafen?",
      answer:
  ...
  fr: [
    {
      question: "Comment garder mon lit propre avec une rupture d'Achille?",
      answer:
    ...
    {
      question: "L'attelle est-elle plus hygiénique que dormir dans ma botte?",
      answer:
    ...
    {
      question: "À quelle fréquence dois-je laver la doublure de l'attelle?",
      answer:
  ...
  it: [
    {
      question: "Come mantengo il mio letto pulito con la rottura dell'Achille?",
      answer:
    ...
    {
      question: "Quanto spesso dovrei lavare il rivestimento della stecca?",
      answer:
