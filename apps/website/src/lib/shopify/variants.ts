...
export function getVariantId(size: "large" | "small", side: "left" | "right"): string {
  const key = `${size}${
...
export const CHECKOUT_LINKS = {
  largeLeft: "https://shop.thetismedical.com/cart/47494539673928:1?channel=buy_button",
  largeRight: "https://shop.thetismedical.com/cart/47494539608392:1?channel=buy_button",
  smallLeft: "https://shop.thetismedical.com/cart/47494539706696:1?channel=buy_button",
  smallRight: "https://shop.thetismedical.com/cart/47494539641160:1?channel=buy_button",
} as const;

export function getCheckoutLink(size: "large" | "small", side: "left" | "right"): string {
  const key = `${size}${
    side.charAt(0).toUpperCase() + side.slice(1)
