...
import { getRouteBySlugAndLanguage, getAlternateRoutesForSlug } from "../content/routes";
 ...
 */
export function getAlternateLanguageLinks(slug: string, currentLangCode: string) {
 ...
 */
export function generateHreflangLinks(slug: string, baseUrl: string = 'https://thetismedical.com') {
  const hreflangs = [];
 ...
 */
export function getCanonicalUrl(slug: string, langCode: string, baseUrl: string = 'https://thetismedical.com'): string {
