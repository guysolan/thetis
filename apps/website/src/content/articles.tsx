...
export const articles = [
  {
    ...
    tags: [
      { words: "Treatment", color: "bg-figma-orange" },
      { words: "Recovery", color: "bg-figma-purple" },
    ],
  ...
  },
  {
    ...
    tags: [{ words: "Treatment", color: "bg-figma-orange" }],
    image: AchillesDrawing,
    icon: <Activity />,
  },
  {
    ...
    tags: [{ words: "Diagnosis", color: "bg-figma-gray" }],
    icon: <Stethoscope />,
  },

  {
    ...
    tags: [{ words: "Recovery", color: "bg-figma-purple" }],
    image: AchillesDrawing,
    icon: <Hourglass />,
  },
  {
  ...
  },
  {
    ...
    tags: [{ words: "Equipment", color: "bg-figma-blue" }],
