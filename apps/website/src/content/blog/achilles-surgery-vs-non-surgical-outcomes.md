...
heroImage: "/images/blog/achilles-surgery-vs-non-surgical-outcomes.png"
heroAlt: "Infographic titled Treatment Outcomes Surgery vs Non-Surgical: two 100-person icon grids comparing surgical and non-surgical pathways, with success and re-rupture percentages and a note that modern non-operative care uses functional rehabilitation"
tags: ["surgery", "treatment", "research", "recovery"]
source:
  title: "Operative treatment versus nonoperative treatment of Achilles tendon ruptures: systematic review and meta-analysis"
  url: "https://pubmed.ncbi.nlm.nih.gov/30617123/"
  authors: "Ochen Y, et al.; BMJ (2019)"
faqs:
  - question: "Do I need surgery for an Achilles tendon rupture?"
    answer: "Not everyone does. In many health systems, non-surgical treatment in a walking boot with a structured protocol is first-line. Surgery is considered when your team believes the benefits outweigh the risks for your situation — for example certain gap patterns, high-demand sport, or other individual factors. The decision should be shared between you and your clinician."
  - question: "Is non-surgical treatment as good as surgery?"
    answer: "Large studies show that many people do very well without surgery. A pooled analysis (Ochen et al., BMJ 2019) found that overall re-rupture rates were low in both groups, with a small absolute difference favouring surgery, but surgery carried more other complications — mainly infection-related. Long-term function depends heavily on rehabilitation and adherence, not only on whether you had an operation."
  - question: "What did the UKSTAR trial actually compare?"
    answer: "UKSTAR compared two non-operative pathways: a traditional plaster cast versus early weight-bearing in a functional brace. It did not compare surgery to non-surgery. Its main message was that the functional brace pathway was safe and cost-effective compared with casting, with similar outcomes at nine months — not that surgery is unnecessary for everyone."
  - question: "If surgery lowers re-rupture risk, why is non-surgical care often offered first?"
    answer: "Because re-rupture is uncommon overall, the extra protection from surgery is small on average when expressed as people affected per 100 — while surgery adds different risks, including wound problems and infection. Teams balance those trade-offs against your tear pattern, health, activity goals, and how reliable bracing and follow-up are likely to be for you."
  - question: "What are warning signs after surgery or when changing boot settings?"
    answer: "After surgery, spreading redness, pus, fever, or rapidly worsening wound pain need urgent review. For anyone in a boot, a new pop or snap, a feeling of giving way, or severe pain like the original injury needs urgent assessment. Minor calf tightness after a protocol change is common; unrelenting pain or instability is not — call your team."
---
...
This article summarises what a major **systematic review** says about **operative vs non-operative** care, clarifies what the **UKSTAR** trial did (and did not) prove, and explains how **functional rehabilitation** has changed what “non-operative” means today — with links to practical topics like [boot choice](/blog/aircast-vs-vacoped) and [wedge progression](/blog/achilles-boot-wedge-removal-protocol).

## Contents

- [Key Takeaways](#key-takeaways)
- [What the Numbers Actually Say (Ochen et al., BMJ 2019)](#what-the-numbers-actually-say-ochen-et-al-bmj-2019)
- [Surgery vs Non-Surgical: A Side-by-Side View](#surgery-vs-non-surgical-a-side-by-side-view)
- [UKSTAR Is Not the Same Comparison](#ukstar-is-not-the-same-comparison)
- [Why “Non-Op” Today Is Not Just Eight Weeks in a Cast](#why-non-op-today-is-not-just-eight-weeks-in-a-cast)
- [How Decisions Are Usually Made](#how-decisions-are-usually-made)
...
- **Your** decision should reflect **your tear**, **your health**, **your goals**, and **your ability to follow the plan** — see also [foot position and why “toes down” matters early](/blog/foot-position-achilles-rupture-recovery)
...
If you want a deeper dive into **early protection** and how healing progresses, read [Achilles tendon healing and early protection](/blog/achilles-tendon-healing-early-protection).
...
- A **walking boot** with careful **angle control** ([wedges or hinge](/blog/aircast-vs-vacoped))
- **Protected weight-bearing** as your protocol allows
- **Gradual progression** of ankle position — see [wedge removal principles](/blog/achilles-boot-wedge-removal-protocol)
...
1. **Do not confuse “small average differences” with “no difference to you.”** Pooled statistics hide individual variation — your surgeon’s recommendation should be personal  
2. **Ask for written protocols** — dates for boot changes, weight-bearing, and physiotherapy checkpoints reduce anxiety  
3. **Plan for the boring stuff** — [sleep](/achilles-rupture-splint), swelling control, and follow-up attendance often decide outcomes more than the theatre vs no-theatre label  
4. **Use reliable timelines as orientation, not prophecy** — our [Achilles rupture timeline](/FAQs/achilles-rupture-timeline) FAQ explains why weeks differ between people  
5. **Structured education helps** — the [Achilles recovery course](/course) is designed around the same practical rules: protect early, progress gradually, avoid heroics  
...
1. Ochen Y, Beks RB, van Heijl M, et al. Operative treatment versus nonoperative treatment of Achilles tendon ruptures: systematic review and meta-analysis. *BMJ*. 2019;364:k5120. [PubMed](https://pubmed.ncbi.nlm.nih.gov/30617123/)

2. Costa ML, Achten J, Marian IR, et al. Plaster cast versus functional brace for non-surgical treatment of Achilles tendon rupture (UKSTAR): a multicentre randomised controlled trial and economic evaluation. *Lancet*. 2020;395(10222):441-448. [PubMed](https://pubmed.ncbi.nlm.nih.gov/32035553/)

3. Maffulli N, Peretti GM. Surgery or conservative management for Achilles tendon rupture? *BMJ*. 2019;364:k5344. (Editorial commentary on Ochen *et al.*) [PubMed](https://pubmed.ncbi.nlm.nih.gov/30617220/)

4. Egger AC, Berkowitz MJ. Achilles tendon injuries. *Curr Rev Musculoskelet Med*. 2017;10(1):72-80. [PubMed](https://pubmed.ncbi.nlm.nih.gov/28194638/)

5. Khan RJ, Carey Smith RL. Surgical interventions for treating acute Achilles tendon ruptures. *Cochrane Database Syst Rev*. 2010;(9):CD003674. [PubMed](https://pubmed.ncbi.nlm.nih.gov/20824836/)
