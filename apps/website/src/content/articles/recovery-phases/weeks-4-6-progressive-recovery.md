---
title: "Achilles Rupture Weeks 4-6: Wedge Removal, Walking Progress & Sleep Tips (2025)"
...
tags: ["recovery", "weeks-4-6", "wedges", "healing", "night-splint"]
phase: "weeks-4-6"
---

# Weeks 4-6: Progressive Recovery - Removing Wedges and Building Confidence
...
**The Proliferative Phase (Days to Weeks):**
...
[GRAPHIC: Diagram showing collagen formation during proliferative phase with disorganised Type III collagen fibers]
...
**"Recovery is a game of Snakes and Ladders":**
Each week sees you climbing closer to the finish. But one mistake - one moment of unprotected dorsiflexion, one premature wedge removal, one slip without your boot - is like landing on the big snake that takes you right back to the beginning.

**The risk of re-rupture:**

- The healing tendon can tear again if overloaded
- Re-rupture almost always requires surgery
- Recovery starts from zero with additional complications
- The first 12 weeks are the highest risk period
...
**The reality:** A few weeks of careful compliance now means a lifetime of full function. A few minutes of impatience could mean permanent limitations.
...
**Important:** Always remove wedges at your scheduled time - not earlier, even if you feel ready. Always follow your specific protocol from your hospital.

### Understanding Angle Progression (30° to 20° to 10°)

The angles matter more than you might think. Each reduction brings your tendon ends slightly further apart, placing more tension on the healing tissue.

**Why gradual progression works:**

- Allows the healing tissue to adapt to increased load
- Stimulates collagen alignment along the lines of force
- Prevents sudden stress that could cause failure
- Mimics the natural healing process

**What you'll notice with each wedge removal:**

- A slight increase in tightness or pulling sensation
- This is normal and expected
- Increased awareness of the tendon area
- Possible temporary increase in stiffness after rest
...
If you experience any of these, contact your medical team immediately.

[GRAPHIC: Visual timeline showing wedge removal with ankle angle changes from 30° to neutral]

### What to Expect as Your Foot Position Changes

As your foot gradually moves towards neutral, you'll notice changes in how walking feels:
...
- Increased confidence as you progress
- Temptation to do more (resist this urge)
- Excitement about approaching the end of boot wearing
- Possible frustration at the slow pace (this is normal)

**Practical considerations:**

- Your walking pattern will change slightly with each wedge removal
- You may need to readjust the EVENup on your other shoe
- Walking distance capacity may temporarily decrease then improve
- Give yourself a day or two to adapt after each change
...
**Signs you're ready for full weight-bearing:**

- You can walk without significant pain in the boot
- You're not relying heavily on crutches for weight support
- Swelling is manageable
- Your specialist has confirmed you can progress
...
### Improving Your Gait in the Boot

A good walking pattern now sets you up for easier transition later.

**Practice these elements:**

- **Even timing:** Spend equal time on each leg
- **Arm swing:** Use natural arm swing for balance
- **Core engagement:** Keep your abdomen slightly engaged
- **Head up:** Look ahead, not at your feet
- **Relaxed shoulders:** Tension creates asymmetry

**Exercises to improve gait (in the boot):**

- Practice walking in front of a mirror
- Walk slowly and deliberately, focusing on technique
- Gradually increase walking duration
- Walk on different surfaces (flat, slight slopes, carpet, tile)
...
- Attach to your non-injured foot's shoe
- Choose the right size for your boot height
- Wear it whenever you're walking in the boot
- Check it's secure before walking
...
If you've been walking in your boot without a shoe leveler, you may have already developed some compensatory pain. This usually resolves once you start using the EVENup.
...
**Important warning:** Generic "night splints" sold for plantar fasciitis hold your foot in dorsiflexion (toes pointing up). This is the OPPOSITE of what you need and could seriously damage your healing tendon. Only use a splint specifically designed for Achilles rupture.
...
- Boot lasts longer (not worn to bed)
- Boot stays cleaner
...
Using a night splint correctly is essential for safety:

**Application:**

1. Remove your boot
2. Slide your foot into the splint
3. Secure all straps snugly but not too tight
4. Check your foot is in the correct position
5. Your toes should be pointing downward
...
- Ensure circulation is good (no numbness or colour changes)
- Report any concerns to your medical team
...
- More walking = more blood flow to the area
- Your body is still healing
- Gravity pulls fluid to your lower leg
...
- When resting with the boot off briefly (with night splint or extreme caution), let your foot air out
- Use a fan to cool your foot when stationary
- Keep the boot liner clean

**Hygiene routine:**

- Wash your foot daily when possible (carefully, with boot nearby)
- Dry thoroughly, especially between toes
- Apply antifungal powder
- Use a thin sock barrier between foot and boot liner
...
- Frustration at the slow pace of recovery
- Cabin fever from reduced mobility
- Anxiety about the future and full recovery
...
3. **Stay connected:** Talk to friends, family, or online communities of people with similar injuries.
...
6. **Stay as active as possible:** Upper body exercises, seated movements, mental exercises.

7. **Seek help if needed:** If you're struggling significantly, talk to your GP.

**Remember:** This phase is temporary. You will recover. Many people come through Achilles rupture with a renewed appreciation for their mobility and health.
...
- Modified planks (on your good knee and forearms)
- Seated oblique twists
- Breathing exercises for deep core activation

**Why this matters:**

- Maintains overall fitness
- Prevents muscle loss during immobility
- Improves mood and mental health
- Makes the later rehabilitation phases easier
- Helps maintain a healthy weight

### Low-Impact Cardio Options

Maintaining cardiovascular fitness is challenging but possible:

**Options:**

- **Arm ergometer (arm bike):** If you have gym access
- **Seated boxing/punching:** Shadow boxing while seated
- **Chair aerobics:** Many YouTube videos available
- **Resistance band cardio:** High-rep, low-resistance arm exercises
- **Deep breathing exercises:** Help maintain lung capacity

**What to avoid:**

- Any exercise that loads the injured leg
- Jumping or hopping
- Standing exercises
- Exercises that risk you falling

---

## Essential Purchases for Weeks 4-6
...
## Looking Ahead - Preparing for Physio

### What to Expect in Weeks 7-9

The next phase brings you closer to saying goodbye to your boot. Here's what's coming:

**Weeks 7-9 milestones:**

- Removal of remaining wedges (reaching neutral)
- Continued improvement in walking
- Preparation for physiotherapy
- Possible transition planning for boot removal

**Physical preparation:**

- Continue with gentle in-boot exercises
...
- Start thinking about your physiotherapy goals
- Identify local physiotherapists with Achilles experience
- Prepare questions for your next specialist appointment
- Set realistic expectations for the timeline ahead

---

## FAQs for Weeks 4-6

### My calf feels very tight - should I stretch it?

**No!** Do not stretch your calf or Achilles tendon. The tightness you're feeling is the healing tissue, and it SHOULD be tight. Stretching could elongate the tendon or even cause re-rupture. The tightness will gradually reduce naturally with time and proper rehabilitation (starting later).

### How much walking is too much?

Listen to your body. Signs you're doing too much:

- Swelling that doesn't resolve overnight with elevation
- Increasing pain or discomfort
- Exhaustion or inability to complete normal daily tasks
- Visible limping or gait deterioration

Start with 5-10 minute walks and gradually increase. Rest days are okay.

### Can I remove the boot to shower now?

This depends on your specific protocol. Some people can briefly remove the boot for showering if:

- They keep the foot completely still
- They don't put weight through it
- They're extremely careful not to bend the ankle up
- Their specialist has approved it

If in doubt, continue using a waterproof cover. Safety first.

### Is it normal to feel nervous about removing wedges?

Yes, this is very common. The boot has been your safety net, and each change can feel scary. Trust the process - the wedge removal schedule is designed to be gradual and safe.

### My other knee/hip/back is hurting - is this normal?

Unfortunately, yes. Walking asymmetrically in a boot commonly causes compensatory pain in other areas. Solutions:

- Use an EVENup shoe leveler
- Take rest breaks during walking
- Don't overdo walking distances
- Use good walking technique
- Consider seeing a physiotherapist for exercises to address these issues

### When can I drive?

- **Right leg injured:** You cannot drive until you're out of the boot and cleared by your medical team (typically week 10-12 at earliest)
- **Left leg injured (automatic car):** Some people can drive once they're confident and comfortable, but check with your insurance company and medical team first

### Can I travel by plane?

Flying with an Achilles rupture is possible but requires precautions:

- Higher DVT risk during flights - take blood thinners as prescribed
- Move your feet and ankles regularly (with boot on)
- Stay hydrated
- Request an aisle seat for easier movement
- Inform the airline about your injury
- Consider compression stockings
- Short flights are generally fine; long-haul flights require more planning
...
- [ ] Start gentle in-boot exercises
- [ ] Maintain upper body and core strength
- [ ] Address mental health needs
- [ ] Prepare for physio (research providers, prepare questions)

**Remember:** These weeks are about steady, consistent progress. Trust the timeline, protect your tendon, and keep moving forward.
