---
title: "Achilles Rupture Weeks 1-3: Surgery vs Non-Surgical Treatment Decision Guide (2025)"
...
tags: ["recovery", "weeks-1-3", "treatment", "surgery", "boots"]
phase: "weeks-1-3"
---

# Weeks 1-3: Making Your Treatment Decision - Surgery or Conservative Care
...
[GRAPHIC: Diagram showing Thompson test - positive vs negative result]
...
**Key information from imaging:**

- The size of any gap between tendon ends
- Whether the tendon ends will come together in a pointed foot position
- The overall quality of the tendon tissue
...
- 1-2 weeks in a cast, then a walking boot
- Same rehabilitation protocol as non-surgical treatment
...
Non-surgical (conservative) treatment involves:
...
- The tendon ends heal naturally when held in the right position
- The body forms scar tissue that bridges the gap
- This healed tendon is just as strong as a surgically repaired one
...
Comparing plaster casting vs functional bracing (boot with early weight-bearing):
...
- Non-surgical treatment with a walking boot is the first-line treatment for most people
- Surgery is reserved for specific circumstances
- Early weight-bearing and functional rehabilitation are key to success
...
- Inexpensive
- Easy to adjust
- Widely used and familiar to clinicians

**Cons:**

- May not achieve optimal ankle positioning
- Fixed positions between wedge changes
- Not waterproof
- Can cause some gait abnormalities
...
- Potentially better ankle positioning
- Allows controlled movement within safe range
- May preserve muscle better
- Waterproof capability
- More natural walking pattern (once hinge unlocked)
...
- Thicker base can feel awkward

[GRAPHIC: Side-by-side comparison of Aircast and VACOped boots]

**The bottom line:** Both boots can produce excellent outcomes. Use whatever your hospital provides and follow the protocol carefully. The commitment to wearing it properly matters more than which brand you have.
...
Your specialist will give you a specific schedule for wedge removal. Follow it exactly.

[GRAPHIC: Visual timeline showing wedge removal progression with ankle angle illustrations]
...
This cannot be emphasised enough: **Your boot must be worn 24 hours a day, 7 days a week** during these early weeks.
...
**Important:** Do NOT use a generic "night splint" designed for plantar fasciitis. These hold the foot in the wrong position (dorsiflexion) and could damage your healing tendon. Only use a splint specifically designed for Achilles rupture.
...
**If you experience PE symptoms, call 999 immediately.**
...
### Surgery was recommended - should I be worried?

Not necessarily. Surgery is sometimes recommended for specific reasons:

- A significant gap between tendon ends
- Very active lifestyle/professional athlete
- Previous Achilles problems
- Certain tendon characteristics on imaging

If surgery is recommended, ask your surgeon to explain why and discuss the risks and benefits for your specific situation.
...
### Can I walk on my heel with the boot?

Yes, when walking in the boot, you should walk as normally as possible with a heel-to-toe motion. The boot is designed to protect your tendon while allowing walking.

### How often should I take the boot off?

In weeks 1-3, the boot should stay on 24/7. The only exceptions are:

- Brief periods for showering (with extreme care)
- Using a night splint (if approved by your specialist)
- Specific exercises prescribed by your physiotherapist (not usually this early)

### When can I stop using crutches?

This varies by individual, but many people can reduce crutch use by weeks 2-3 and stop using them by weeks 3-4. Always follow your specific protocol and don't rush.

### Is it normal for my ankle to feel stiff?

Yes, this is completely normal. Your ankle has been immobilised, and stiffness is expected. Do NOT try to stretch it yourself. The flexibility will return naturally with time and proper physiotherapy.

### My tendon feels tight - is that bad?

No, tightness is normal and actually a good sign. It means your tendon is healing in a shortened position, which is what we want. Do NOT stretch or massage the tendon. Let it heal.

### Can I remove wedges early if I feel ready?

Absolutely not. Follow your prescribed wedge removal schedule exactly. Removing wedges early could cause your tendon to heal elongated, permanently reducing your ankle power.
...
**Remember:** These weeks are about protection and patience. The decisions made now set the foundation for your entire recovery.
