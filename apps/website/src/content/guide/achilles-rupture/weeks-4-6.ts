...
export const metadata: GuideMetadata = {
  ...
  phaseSubtitle: "Progressive Recovery",
  hubCardTitle: "Progressive Recovery",
...
export const content: GuideContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      title: "Key Concept",
      content:
        "**Tendon elongation is THE biggest problem** affecting long-term recovery from Achilles rupture. If your tendon heals too elongated (stretched), you'll permanently lose push-off power. Research shows elongation is more important than re-rupture risk (which is low at 2-4%).",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      content:
        'Generic "night splints" sold for plantar fasciitis hold your foot in dorsiflexion (toes pointing up). This is the OPPOSITE of what you need and could seriously damage your healing tendon. Only use a splint specifically designed for Achilles rupture.',
    },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Listen to your body. Signs you're doing too much: swelling that doesn't resolve overnight with elevation, increasing pain or discomfort, exhaustion, visible limping. Start with 5-10 minute walks and gradually increase. Rest days are okay.",
        },
        {
          question: "Can I remove the boot to shower now?",
          answer:
            "This depends on your specific protocol. Some people can briefly remove the boot for showering if they keep the foot completely still, don't put weight through it, are extremely careful not to bend the ankle up, and their specialist has approved it. If in doubt, continue using a waterproof cover.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "**Right leg injured:** You cannot drive until you're out of the boot and cleared by your medical team (typically week 10-12 at earliest). **Left leg injured (automatic car):** Some people can drive once confident and comfortable, but check with your insurance company and medical team first.",
        },
        {
          question: "Can I travel by plane?",
          answer:
            "Flying with an Achilles rupture is possible but requires precautions: higher DVT risk (take blood thinners as prescribed), move feet and ankles regularly, stay hydrated, request an aisle seat, inform the airline, consider compression stockings. Short flights are generally fine; long-haul requires more planning.",
        },
      ],
    },
