...
export const metadata: GuideMetadata = {
  ...
  description:
    "Complete guide to weeks 10-12 of Achilles rupture recovery. Learn about transitioning out of your boot, choosing the right shoes, starting physiotherapy, key exercises, and what NOT to do.",
  phase: "weeks-10-12",
  ...
  phaseSubtitle: "Boot Transition",
  hubCardTitle: "Boot Transition",
  timelineColor: "bg-lime-500",
};
...
export const content: GuideContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      title: "Why the Delay?",
      content:
        "Your tendon needs to handle ~1.5x body weight forces during walking. Research shows keeping the boot longer (with aggressive loading inside it) prevents elongation. The goal: Build tendon strength BEFORE exposing it to walking forces.",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      content:
        'Many people reduce their exercise compliance as they start feeling better. This is when doing the exercises is MOST important. The early "easy" exercises build the foundation for harder ones later.',
    },
    ...
    },
    {
      ...
      title: "Warning",
      content:
        "This phase is when many people make mistakes that set back their recovery. The tendon can still be damaged by inappropriate loading.",
    },
    {
      type: "dos-donts",
      dos: [
      ...
      items: [
        {
          ...
          answer:
            "Evidence-based protocols recommend weeks 11-12, based on force-based criteria (ability to do seated calf raises with 0.8-1x body weight), not just time. Wait for your specialist's clearance - don't self-prescribe.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Start with short walks (5-10 minutes) several times a day rather than one long walk. Gradually increase duration as your strength and confidence improve. Rest when fatigued.",
        },
        {
          question: "Can I start running or jumping?",
          answer:
            "Absolutely not - not for several more months. Running and jumping create forces 2-3x body weight. Your tendon isn't ready. Focus on walking and basic strengthening first.",
        },
        {
          question: "Should I stretch my Achilles to loosen it up?",
          answer:
            "No! Avoid aggressive stretching for up to a year. The tightness is normal healing tissue. Let range of motion return naturally through active exercises and normal movement.",
        },
        {
          question: "What if I fall or trip?",
          answer:
            'Minor stumbles are unlikely to cause damage if you\'re following proper protocol. However, if you have a significant fall, sudden pain, or hear a "pop," contact your medical team immediately.',
        },
      ],
    },
    ...
    },
    {
      ...
      variant: "success",
      content:
        "**Congratulations on reaching this milestone!** The boot is behind you, but the real work of rebuilding strength is just beginning. Stay consistent with your exercises and trust the process.",
    },
  ],
};
