...
export const metadata: GuideMetadata = {
  ...
  phaseSubtitle: "Treatment Decision",
  hubCardTitle: "Treatment Decision",
...
export const content: GuideContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      content:
        "**Overall re-rupture rates are LOW: 2-4%** regardless of surgery or non-surgery. This is very different from ACL injuries (20% re-rupture rate). The difference between surgical and non-surgical re-rupture rates is small. **Re-rupture is NOT the main problem** - elongation is the bigger concern.",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      title: "Important",
      content:
        'Do NOT use a generic "night splint" designed for plantar fasciitis. These hold the foot in the wrong position (dorsiflexion) and could damage your healing tendon. Only use a splint specifically designed for Achilles rupture.',
    },
