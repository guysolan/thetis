...
export const metadata: GuideMetadata = {
  ...
  description:
    "Complete guide to week 26 and beyond of Achilles rupture recovery. Learn about return-to-sport criteria, running progressions, plyometrics, preventing re-rupture, and what life looks like after full recovery.",
  phase: "week-26-plus",
  weekRange: "Week 26+",
  highlights: [
  ...
  phaseSubtitle: "Return to Sport",
  hubCardTitle: "Return to Sport",
...
export const content: GuideContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      rows: [
        [
          ...
          "Ambitious, not always recommended",
        ],
        ...
        [
          ...
          "NBA standard, sensible approach",
        ],
    ...
    },
    {
      ...
      content:
        "Just because you CAN return to sport at 6 months doesn't mean you MUST. Taking longer is completely acceptable and often safer. **12 months is sensible** for most people, especially for high-level sport.",
    },
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "**Isokinetic strength** >90% limb symmetry (if tested)",
          checked: false,
        },
        {
          text:
    ...
    },
    {
      ...
      items: [
        {
          text: "**Pain-free jogging:** 10+ minutes continuous",
          checked: false,
        },
        {
          text:
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "Completed pre-running plyometric preparation",
          checked: false,
        },
      ],
    },
    ...
    },
    {
      ...
      title: "The 10% Rule",
      content:
        "Increase weekly running volume by no more than 10%. This applies to both distance and intensity. If week 1 = 10km total, week 2 = max 11km.",
    },
    {
      type: "text",
      ...
      items: [
        {
          ...
          answer:
            "The healed tendon may be slightly different (thicker, sometimes stiffer), but functional outcomes are usually excellent. Many athletes return to full competition.",
        },
        {
          question: "Can I run marathons or play competitive sport?",
          answer:
            "Yes, with proper rehabilitation. Many people return to running, football, tennis, and other demanding activities. It requires patience and consistent strengthening.",
        },
        {
          question: "Will I always have to be careful?",
          answer:
            "Once fully recovered (12-18 months), most people can live normally. Maintaining calf strength through regular exercise is the best protection.",
        },
        {
          question: "What about the other Achilles?",
          answer:
            "There's a small increased risk to the other side (about 2-6%). Bilateral calf strengthening helps protect both tendons.",
        },
        {
          question: "Is it normal for my tendon to feel different?",
          answer:
            "Yes. The healed tendon is typically thicker and may feel different. This is normal and doesn't affect function. Most people stop noticing after a while.",
        },
        {
          question: "What if I feel twinges or sensations during sport?",
          answer:
            "Some sensations are normal, especially during the first year back. Learn to distinguish normal post-exercise feelings from warning signs. Sharp pain, sudden weakness, or a 'pop' sensation should prompt medical review.",
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        {
          text: "Meet all return-to-sport criteria before returning",
          checked: false,
        },
        ...
        {
          text: "Work with your physio on sport-specific goals",
          checked: false,
        },
    ...
    },
    {
      ...
      content:
        "You've come through one of the most challenging injuries in sport. Achilles rupture recovery is demanding, but with patience, consistency, and proper rehabilitation, most people achieve excellent outcomes. You've invested months in healing - now you get to enjoy the results. **You've got this.**",
    },
  ],
};
