...
export const metadata: GuideMetadata = {
  ...
  description:
    "Complete guide to weeks 7-9 of Achilles rupture recovery. Learn about the remodelling phase, final wedge removal, preparing for physiotherapy, returning to work, and driving after Achilles injury.",
  phase: "weeks-7-9",
  weekRange: "Weeks 7-9",
  highlights: [
    "Final wedge removal",
  ...
  phaseSubtitle: "Final Boot Phase",
  hubCardTitle: "Final Boot Phase",
...
export const content: GuideContent = {
  ...
  blocks: [
    ...
    },
    {
      type: "text",
      content:
        "**Important caveats:** These are rough estimates based on research. Individual variation is significant. The tendon may never be 100% identical to before, but functional strength can be excellent.",
    },
    ...
    },
    {
      type: "text",
      content:
        "**What affects your timeline:** Age (younger = generally faster recovery), pre-injury fitness level, compliance with rehabilitation, whether you had surgery, individual healing rate, quality of physiotherapy.",
    },
    ...
    },
    {
      type: "text",
      content:
        "**Workplace accommodations to request:** Parking closer to entrance, ground floor access or elevator, flexible schedule for appointments, ability to elevate leg at desk, reduced walking initially.",
    },
    ...
    },
    {
      type: "text",
      content:
        '**Common feelings:** Excitement at finally being "free", fear about walking without protection, anxiety about re-injury, uncertainty about the future, impatience to be "normal" again.',
    },
    {
      type: "text",
      ...
      items: [
        {
          ...
          answer:
            "**Evidence-based protocols** recommend boot removal at **11-12 weeks** (not 8 weeks) for most people. This is based on force-based criteria - your tendon needs to be strong enough to handle walking forces (~1.5x body weight). Wait for specific instruction from your medical team - don't self-prescribe boot removal.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Completely normal. Moving from the protected boot phase to active rehabilitation is a significant psychological transition. Acknowledge your feelings, seek support if needed, and trust the process.",
        },
      ],
    },
