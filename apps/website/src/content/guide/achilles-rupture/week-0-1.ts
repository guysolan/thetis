...
export const metadata: GuideMetadata = {
  ...
  phaseSubtitle: "First Week",
  hubCardTitle: "First Week After Rupture",
...
export const content: GuideContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      title: "Safety Note",
      content:
        "Protocols vary by country and hospital. Use this guide to understand what's typical, but follow your clinician's instructions if they differ.",
    },
    ...
    },
    {
      ...
      title: "Important",
      content:
        'Partial ruptures/tears can happen (they\'re **uncommon**), but the classic "pop / kicked in the back of the ankle" story is strongly associated with a full rupture. If you felt that distinctive snap, treat it as a rupture until a clinician confirms otherwise.',
    },
    ...
    },
    {
      ...
      content:
        "A large multi-centre UK audit found **~3.7% symptomatic VTE** after Achilles rupture, versus **~0.57%** after other foot/ankle surgery (about **6.5× higher**). Studies that actively screen often find higher rates of (often symptomless) clots.",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      variant: "danger",
      content:
        "These PE symptoms require URGENT medical attention. Call 999 or go to A&E immediately.",
    },
    ...
    },
    {
      ...
      title: "The Good News",
      content:
        "Modern research (including the landmark UKSTAR trial) shows that non-surgical treatment with early weight-bearing in a boot produces outcomes comparable to surgery for most people, with fewer complications.",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "**Plaster cast:** No, absolutely not. Use a waterproof cover. **Walking boot:** Generally, no - but follow your specific instructions. Most protocols require 24/7 boot wear initially. **Some splints:** May be removable for brief periods - but only if specifically told this is okay.",
        },
        {
