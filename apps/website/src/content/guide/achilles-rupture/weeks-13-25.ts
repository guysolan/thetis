...
export const metadata: GuideMetadata = {
  ...
  hubCardTitle: "Progressive Strengthening",
  ...
  blocks: [
    ...
    },
    {
      ...
      rows: [
        [
          "Weeks 13-16",
          "Walk 20-30 min comfortably, 20+ double-leg heel raises, good balance, minimal swelling",
        ],
        [
          "Weeks 17-20",
          "Single-leg raises beginning (with support), 30+ min walking, light stationary cycling, stairs normally",
        ],
        [
          "Weeks 21-25",
          "10+ single-leg raises, consideration of light jogging (if criteria met), near-normal activities",
        ],
      ],
    },
    ...
    },
    {
      ...
      content:
        "Instead of aggressive stretching, dorsiflexion is introduced progressively through **loaded exercises**. This is safer than passive stretching and strengthens the tendon while improving range.",
    },
    {
      type: "text",
    ...
    },
    {
      ...
      rows: [
        ...
        [
          "4",
          "Single-leg stance with arm movements or catching ball",
          "30 seconds",
        ],
      ],
    },
      ...
      items: [
        {
          ...
          answer:
            "Tendon healing is inherently slow due to limited blood supply. Full recovery takes 6-12 months. The remodelling phase continues for 12-18+ months. Rushing causes problems - patience leads to better outcomes.",
        },
        {
          question:
            "My calf looks smaller than the other side - is this permanent?",
          answer:
            "Muscle atrophy is normal and expected after immobilisation. It takes 6-12+ months for calf size to approach normal. Some permanent difference may persist (usually small), but ongoing strengthening helps.",
        },
        {
          question: "I still have some stiffness - is this normal?",
          answer:
            "Some residual stiffness is common and usually improves over time. Continue range of motion exercises but don't stretch aggressively. Flexibility returns naturally with loaded dorsiflexion exercises.",
        },
        {
          question: "When can I play sport again?",
          answer:
            "Return to sport is typically considered from 6 months, but 9-12 months is more realistic for most people. It should be based on meeting strength criteria (25+ single-leg heel raises, hop tests, etc.), not just time.",
        },
        {
          question: "Can I start running?",
          answer:
            "Running usually begins around week 20-24+ IF you meet criteria: 15-20+ single-leg heel raises, pain-free walking 30+ minutes, good balance. Start with walk-jog intervals and progress gradually.",
        },
        {
          question: "How often should I do my exercises?",
          answer:
            "Follow your physiotherapist's guidance, but typically calf strengthening exercises are done 3-4 times per week (not daily - rest days are important for tendon adaptation).",
        },
        {
          question: "Should I still be taking blood thinners?",
          answer:
            "Blood thinners are typically stopped once you're fully weight-bearing and mobile (usually by week 10-12). Follow your medical team's specific guidance.",
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        {
          text: "Progress heel raises from double to single leg",
          checked: false,
        },
        { text: "Build up to 15+ single-leg heel raises", checked: false },
        {
          text: "Introduce progressive dorsiflexion with plates",
          checked: false,
        },
        ...
        {
          text: "Consider eccentric exercises (with physio approval)",
          checked: false,
        },
    ...
    },
    {
      ...
      variant: "success",
      content:
        "**This phase is a marathon, not a sprint.** Consistency beats intensity. Every week of proper loading makes your tendon stronger and more resilient. Trust the process.",
    },
  ],
};
