...
export const content: GuideContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "**25+ single-leg heel raises** on injured side (ideally >90% limb symmetry)",
          checked: false,
        },
        { text: "**Isokinetic strength** >90% limb symmetry (if tested)", checked: false },
        {
          text: "**Isometric strength** ability to support 2.5-3.0x body weight in calf contraction",
          checked: false,
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        {
          text: "**Single-leg hop for distance:** <10% asymmetry vs uninjured side",
          checked: false,
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "**Sport-specific movements:** cutting, pivoting, sprinting without pain",
          checked: false,
        },
        {
          text: "**Psychological confidence:** feeling ready to return, low fear of re-injury",
          checked: false,
        },
      ],
    },
