...
export const metadata: GuideMetadata = {
  slug: "stage-4",
  title: "Insertional Achilles tendonitis — Stage 4: Return to activity (placeholder)",
  description:
    "Placeholder guide — content coming soon. Building volume and returning to sport.",
  phase: "insertional-achilles-tendonitis-stage-4",
  weekRange: "Stage 4",
