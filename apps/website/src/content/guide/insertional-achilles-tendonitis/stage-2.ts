...
export const metadata: GuideMetadata = {
  slug: "stage-2",
  title: "Insertional Achilles tendonitis — Stage 2: Subacute / loading (placeholder)",
  description:
    "Placeholder guide — content coming soon. Gradual loading and activity modification.",
  phase: "insertional-achilles-tendonitis-stage-2",
  weekRange: "Stage 2",
