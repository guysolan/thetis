...
export const insertionalAchillesTendonitisGuideSections: GuideSection[] = [
...
export const insertionalAchillesTendonitisGuideNavPhases: GuideNavPhase[] =
  insertionalAchillesTendonitisGuideSections.map((s) => ({
    slug: `guide/insertional-achilles-tendonitis/${s.metadata.slug}`,
...
export const insertionalAchillesTendonitisGuideHubPhases:
  ConditionGuideHubPhase[] = insertionalAchillesTendonitisGuideSections.map((
    s,
  ) => ({
    slug: `guide/insertional-achilles-tendonitis/${s.metadata.slug}`,
