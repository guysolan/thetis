...
export function getTimelineContent(lang: Lang): Content {
  const raw = content[lang];
  return {
    ...raw,
    title: withCurrentYear(raw.title),
    description: withCurrentYear(raw.description),
  };
}
...
export const content: Record<Lang, Content> = {
  en: {
    title:
      "Achilles Tendon Rupture Recovery Timeline {year}: Week-by-Week Guide (Surgical & Non-Surgical)",
    description:
      "Comprehensive {year} week-by-week timeline for Achilles tendon rupture recovery after surgery or non-surgical treatment – milestones, exercises, physiotherapy tips, and return-to-sport goals.",
    timelineBlocks: [
      {
        time: "Week 1",
  ...
  es: {
    title:
      "Cronograma de recuperación de la rotura del tendón de Aquiles {year}: Guía semana a semana (quirúrgica y no quirúrgica)",
    description:
      "Cronograma completo semana a semana de {year} para la recuperación de la rotura del tendón de Aquiles después de una cirugía o tratamiento no quirúrgico: hitos, ejercicios, consejos de fisioterapia y objetivos de regreso al deporte.",
    timelineBlocks: [
      {
        time: "Semana 1",
  ...
  fr: {
    title:
      "Calendrier de récupération de la rupture du tendon d'Achille {year} : Guide semaine par semaine (chirurgical et non chirurgical)",
    description:
      "Calendrier complet semaine par semaine de {year} pour la récupération de la rupture du tendon d'Achille après une intervention chirurgicale ou un traitement non chirurgical – jalons, exercices, conseils de physiothérapie et objectifs de retour au sport.",
    timelineBlocks: [
      {
        time: "Semaine 1",
  ...
  de: {
    title:
      "Achillessehnenriss-Heilungszeitplan {year}: Woche-für-Woche-Anleitung (chirurgisch & nicht-chirurgisch)",
    description:
      "Umfassender Woche-für-Woche-Zeitplan für {year} für die Genesung von einem Achillessehnenriss nach einer Operation oder einer nicht-chirurgischen Behandlung – Meilensteine, Übungen, Physiotherapie-Tipps und Ziele für die Rückkehr zum Sport.",
    timelineBlocks: [
      {
        time: "Woche 1",
  ...
  it: {
    title:
      "Cronologia del recupero della rottura del tendine d'Achille {year}: Guida settimana per settimana (chirurgica e non chirurgica)",
    description:
      "Cronologia completa settimana per settimana del {year} per il recupero dalla rottura del tendine d'Achille dopo un intervento chirurgico o un trattamento non chirurgico: traguardi, esercizi, consigli di fisioterapia e obiettivi per il ritorno allo sport.",
    timelineBlocks: [
      {
        time: "Settimana 1",
