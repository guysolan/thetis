...
2. **Protective Gear**:
   - Use a **walking boot** (e.g., [Vacoped](https://dub.sh/NOaCy2D): $350, [Aircast](https://aircastboot.com/): $225) to support your tendon.
...
For night-time, a purpose-built Achilles night splint can help maintain proper foot alignment while you sleep. However, avoid walking or standing while wearing the night splint, and wait at least two weeks post-surgery before using one to ensure your wound has finished healing. See [Thetis Medical’s night splint guidance](https://dub.sh/mmkrz0Z) and always confirm timing with your surgical team.

<p class="not-prose mt-3 flex flex-col gap-2 font-sans text-base leading-snug">
...
<a href="https://www.amazon.com/dp/B09N5KH4F3" class="font-bold text-[color:var(--accent,#2337ff)] underline decoration-2 underline-offset-2 hover:opacity-90" target="_blank" rel="noopener noreferrer">🇺🇸 US — Night splint (Amazon)</a>
</p>
