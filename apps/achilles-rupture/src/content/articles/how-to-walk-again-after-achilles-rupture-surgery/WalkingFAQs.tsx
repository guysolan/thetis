...
const walkingFaqs: FAQItem[] = [
  {
    question: "What should I consider when choosing a walking boot after Achilles rupture surgery?",
    answer:
  ...
  {
    question: "What's the best way to manage pain and swelling after Achilles rupture surgery?",
    answer:
