...
const InfluencialResearchFAQs: React.FC = () => {
  const faqData: FAQItem[] = [
    ...
    {
      question: "What are the benefits of starting movement early after an Achilles tendon injury?",
      answer:
    ...
    {
      question: "What are the signs that my Achilles tendon is healing well during recovery?",
      answer:
    ...
    {
      question: "How does nutrition impact Achilles tendon healing and recovery?",
      answer:
