...
const faqs: FAQ[] = [
    {
        ...
        answer: (
            <div>
                <p>The Thetis night splint solves the #1 complaint during recovery: sleeping in a heavy boot. Benefits include:</p>
    ...
    },
    {
        ...
        answer: (
            <div>
                <p>Patients consistently report it's worth every penny. Here's what they say:</p>
                <ul className="space-y-2 mt-2 pl-5 text-gray-600 list-disc">
                    <li>"This product works perfect to keep my foot in forward flexion as I sleep" - Rob</li>
                    <li>"It was fantastic being able to remove the boot and sleep comfortably" - Anas</li>
                    <li>"This splint has been a very worthwhile purchase" - Patient</li>
                    <li>"It's a good example of a small company that's identified a problem and provided a solution" - Patient</li>
                </ul>
                <p className="mt-4 font-semibold">Consider this: One night of poor sleep affects your recovery. The splint pays for itself in better healing outcomes.</p>
            </div>
        ),
    },
    {
    ...
    },
    {
        ...
        answer: (
            <div>
                <p>Always consult your surgeon first. Most patients start using it after:</p>
                <ul className="space-y-1 mt-2 pl-5 text-gray-600 list-disc">
    ...
    },
    {
        ...
        answer: (
            <div className="space-y-3">
                <p className="font-semibold">Essential items (first 2 weeks):</p>
                ...
                <p className="mt-4 font-semibold">Comfort upgrades (weeks 3-12):</p>
                <ul className="space-y-1 pl-5 text-gray-600 list-disc">
    ...
    },
    {
        ...
        answer: (
            <div>
                ...
                <ul className="space-y-1 mt-2 pl-5 text-gray-600 list-disc">
                    <li><strong>Boot:</strong> 8-12 weeks full time</li>
                    <li><strong>Night splint:</strong> 3-6 months (longer for comfort)</li>
                    <li><strong>EVENup:</strong> As long as wearing boot</li>
                    <li><strong>Crutches:</strong> 2-8 weeks depending on protocol</li>
                </ul>
                <blockquote className="mt-4 pl-4 border-purple-600 border-l-4 text-gray-700 italic">
...
const EquipmentFAQs: React.FC = () => {
    ...
    return (
        <div className="w-full">
            <h2 className="mb-8 font-bold text-3xl text-center">Frequently Asked Questions</h2>
