...
const AmazonPlanPage = () => {
	...
	const hasData = amazonInventory && AMAZON_REGIONS.some((r) => (amazonInventory[r]?.length ?? 0) > 0);
						...
						<>
							...
							<div>
								...
								<p className="text-muted-foreground text-sm mb-2">
									Whole boxes only: small box = 25 SR + 25 SL, large box = 25 LR + 25 LL. Shown when below min; number of boxes from the size that needs most in each pair.
								</p>
								<div className="border rounded-md overflow-x-auto">
									<Table>
										<TableHeader>
