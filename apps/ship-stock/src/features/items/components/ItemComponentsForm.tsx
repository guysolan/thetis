              ...
              <TableRow key={field.id}>
                <TableCell>
                  <Select
                    ...
                    onChange={() => {
                      form.setValue(`item_components.${index}.component_id`, "");
                    }}
                  />
                </TableCell>
                <TableCell>
                  <Select
                    ...
                    options={getFilteredItemOptions(
                      form.watch(`item_components.${index}.component_type`),
                    )}
                  />
                </TableCell>
                <TableCell>
                  <Input name={`item_components.${index}.component_quantity`} type="number" />
                </TableCell>
                <TableCell>
