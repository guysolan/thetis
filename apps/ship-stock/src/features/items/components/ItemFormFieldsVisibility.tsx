          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => toggleField("sku", checked)}
              />
            </div>
            <div className="flex justify-between items-center">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => toggleField("countryOfOrigin", checked)}
              />
            </div>
            <div className="flex justify-between items-center">
              <Label htmlFor="dimensions">Dimensions & Weight</Label>
              <Switch
                id="dimensions"
                checked={visibility.dimensions}
                onCheckedChange={(checked) => toggleField("dimensions", checked)}
              />
            </div>
          </div>
        </div>
