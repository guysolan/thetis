      ...
      <TableBody>
        {companies.map((company) => (
          <TableRow key={company.id}>
            ...
            <TableCell>
              <DefaultContactSelect company={company} showLabel={false} />
            </TableCell>
            <TableCell>
              <DefaultAddressSelect company={company} type="shipping" showLabel={false} />
            </TableCell>
            <TableCell>
              <DefaultAddressSelect company={company} type="billing" showLabel={false} />
            </TableCell>
            <TableCell>
