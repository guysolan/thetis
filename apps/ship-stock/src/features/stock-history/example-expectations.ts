...
const expectedAddress1 = [
  ["Date", "Item 1 Change", "Item 1 Quantity", "Item 2 Change", "Item 2 Quantity"],
  [dayjs().subtract(1, "day").toISOString(), item1[0].change, item1[0].quantity, 0, 0],
  [dayjs().subtract(2, "day").toISOString(), item1[1].change, item1[1].quantity, 0, 0],
];
...
const expectedAddress2 = [
  ...
  [dayjs().subtract(1, "day").toISOString(), 0, 0, item2[0].change, item2[0].quantity, 0, 10],
  [
  ...
  [dayjs().subtract(3, "day").toISOString(), item2[2].quantity, item2[2].quantity, item1[4], 0, 10],
];
