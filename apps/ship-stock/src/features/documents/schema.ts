...
export const documentOptionsSchema = z.object({
  ...
  payment: z.object({
    ...
    ukLocal: z.boolean().default(true),
    globalSwift: z.boolean().default(true),
    cadDomestic: z.boolean().default(true),
    europeaEconomicArea: z.boolean().default(true),
    nonEEA: z.boolean().default(true),
    usaLocal: z.boolean().default(true),
  }),
