...
export const useDocumentOptions = (documentType: DocumentType) => {
    ...
    const documentOptions: DocumentOptions = {
        ...
        payment: {
            show: search?.payment?.show ?? defaults.payment.show,
            ukLocal: search?.payment?.ukLocal ?? defaults.payment.ukLocal,
            globalSwift: search?.payment?.globalSwift ?? defaults.payment.globalSwift,
            cadDomestic: search?.payment?.cadDomestic ?? defaults.payment.cadDomestic,
            europeaEconomicArea: search?.payment?.europeaEconomicArea ?? defaults.payment.europeaEconomicArea,
            nonEEA: search?.payment?.nonEEA ?? defaults.payment.nonEEA,
            usaLocal: search?.payment?.usaLocal ?? defaults.payment.usaLocal,
        },
