...
export const orderTypes = ["sell", "buy", "build", "ship", "count"] as const;
...
export type OrderItemChangeRow = Database["public"]["Tables"]["order_item_changes"]["Row"];
...
export type OrderItem = Database["public"]["Tables"]["order_item_changes"]["Row"];
...
export type StockItemName =
  ...
  | "from_items"
  | "to_items";
export type AddressName = "address_id" | "to_shipping_address_id" | "from_shipping_address_id";
