...
export const EditableOrder = ({ order }: EditableOrderProps) => {
  ...
  const form = useForm<OrderFormData>({
    ...
    defaultValues: {
      ...
      order_date: order.order_date ? order.order_date.split("T")[0] : undefined,
        ...
        <FormProvider {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="gap-6 grid grid-cols-1 lg:grid-cols-3">
              ...
              <DateRangePicker name="delivery_dates" label="Delivery Dates" />
            ...
            <div className="gap-6 grid grid-cols-1 lg:grid-cols-3">
              ...
              />
              <Input name="airwaybill" label="Airwaybill" placeholder="Enter airwaybill number" />
              <Input
            ...
            <Button type="submit" disabled={updateOrder.isPending} className="w-full md:w-auto">
