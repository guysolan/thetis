        ...
        <FormProvider {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div className="gap-4 grid grid-cols-2">
              ...
              <Input name="tax" label="Tax" type="number" step="0.01" placeholder="0.00" />
            </div>
            <div className="gap-4 grid grid-cols-2">
              <Input name="lot_number" label="Lot Number" placeholder="Enter lot number" />
              <Combobox
            ...
            <Button type="submit" size="sm" disabled={updateOrderItemChange.isPending}>
