    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        {fields.map((field, index) => (
          <div key={field.id} className="bg-white shadow-sm p-4 border rounded-sm">
            <div className="flex flex-row items-end gap-1">
              ...
              <Input name={`order_items.${index}.length`} label="Length" type="number" step="1" />
              <Input name={`order_items.${index}.width`} label="Width" type="number" step="1" />
              <Input name={`order_items.${index}.depth`} label="Depth" type="number" step="1" />
              <Input name={`order_items.${index}.depth`} label="Weight" type="number" step="1" />
              <Input
            ...
            {showPackageItems && <PackageItemsList packageIndex={index} />}
          </div>
        ))}
      </div>
      <Button
