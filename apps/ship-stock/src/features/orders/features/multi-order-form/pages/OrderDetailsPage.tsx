...
export function OrderDetailsPage() {
      ...
      <div className="space-y-6">
        ...
        <FieldGroup>
          <div className="gap-4 grid grid-cols-1 lg:grid-cols-2">
            <Select name="order_type" label="Order Type" options={orderTypeOptions} />
            <DatePicker name="order_date" label="Count Date" />
            <div className="lg:col-span-2">
              <AddressSelect name="from_shipping_address_id" label="Location" />
            </div>
          </div>
        </FieldGroup>
      </div>
  ...
  if (isQuote) {
    return (
      <div className="space-y-6">
        <div>
          <h2 className="mb-2 font-semibold text-xl">Quote Details</h2>
          <p className="text-muted-foreground text-sm">
        ...
        <FieldGroup>
          <div className="gap-4 grid grid-cols-1 lg:grid-cols-2">
            <Select name="order_type" label="Order Type" options={orderTypeOptions} />
            <DatePicker name="order_date" label="Quote Date" />
            <Select
              name="currency"
              label="Currency"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">Enter the basic information for this order</p>
      </div>
      ...
      <FieldGroup>
        <div className="gap-4 grid grid-cols-1 lg:grid-cols-2">
          ...
          />
          <div className="lg:col-span-2">
            <DateRangePicker name="delivery_dates" label="Delivery Date Range" />
          </div>
        </div>
      </FieldGroup>
    </div>
