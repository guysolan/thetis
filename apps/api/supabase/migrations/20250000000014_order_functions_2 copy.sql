...
DROP FUNCTION IF EXISTS insert_order_item(in_order_id bigint, in_item_id bigint, in_quantity_change numeric, in_warehouse_id bigint, in_item_price numeric, in_item_tax numeric);
...
CREATE OR REPLACE FUNCTION insert_order_item(in_order_id bigint, in_item_id bigint, in_quantity_change numeric, in_warehouse_id bigint, in_item_price numeric, in_item_tax numeric)
    RETURNS TABLE(
        order_id bigint,
