          ...
          <CardContent className="pt-6">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-muted-foreground">
                {verifying ? "Verifying your order..." : "Loading..."}
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="flex justify-center items-center bg-muted/30 min-h-[80vh]">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              We couldn't find an order matching your email and order number.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" asChild>
                <a href="https://thetismedical.com">Back to Website</a>
              </Button>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="flex justify-center items-center bg-muted/30 min-h-[80vh]">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Redirecting to your course...</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div>
              ...
              {hasPurchase && (
                <p className="mt-1 text-primary text-xs">
                  ✓ Purchase found! Click below to access your course.
                </p>
              )}
            </div>
