...
export function CourseHeader({ badge, title, description, children }: CourseHeaderProps) {
  return (
    <div className="mb-16">
      ...
      <p className="mb-6 max-w-2xl text-muted-foreground text-lg md:text-xl">{description}</p>
      {children}
    </div>
  );
}
