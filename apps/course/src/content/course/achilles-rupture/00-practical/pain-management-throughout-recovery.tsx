...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Understand what's normal — pain changes throughout recovery (or may be minimal)",
        },
        {
          text: "Use pain medication appropriately — as prescribed, not excessively",
        },
        {
          text: "Ice and elevation — help reduce pain and swelling",
        },
        {
          text: "Know when to be concerned — severe pain, new pain, or concerning symptoms",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          rows: [
            ["**Heel pain**", "Pressure from walking in boot", "Gel heel cushion from pharmacy"],
            [
              "**Knee pain**",
              "Awkwardness of high-heeled boot",
              "Usually improves when out of boot",
            ],
            ["**Back/hip pain**", "Asymmetrical walking pattern", "Use shoe leveler on other foot"],
          ],
        },
      ],
    },
