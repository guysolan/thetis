...
export const metadata = {
  ...
  description: "Normal vs concerning symptoms, questions for clinic, essential purchases",
      ...
      content: [
        {
          ...
          items: [
            {
              text: "Keep the tendon protected 24/7 (no stretching, no barefoot testing)",
            },
            {
              text: "Take any prescribed blood thinners as directed (they reduce clot risk)",
            },
            {
              text: "Elevate your ankle above heart level as much as possible",
            },
            {
              text: "Use ice for comfort during the first 3–4 days (if appropriate) — boot off to apply ice; keep foot toes-down while icing",
            },
            {
              text: "Learn safe crutch technique and slow down around stairs/bathroom",
            },
            {
              text: "Book/confirm your fracture clinic/orthopaedics follow-up",
            },
            {
              text: "Know blood clot red flags (DVT = leg clot, PE = lung clot) and circulation/pressure red flags",
            },
          ],
        },
      ],
