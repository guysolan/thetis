...
export const metadata = {
  ...
  description: "Managing frustration, anxiety, depression, and fear of re-injury during recovery",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Acknowledge your feelings — frustration, anxiety, and sadness are normal",
        },
        {
          text: "Stay connected — isolation makes everything harder",
        },
        {
          text: "Set realistic expectations — recovery takes time",
        },
        {
          text: "Celebrate small wins — progress happens gradually",
        },
        {
          text: "Seek support — friends, family, or professional help if needed",
        },
      ],
    },
    {
