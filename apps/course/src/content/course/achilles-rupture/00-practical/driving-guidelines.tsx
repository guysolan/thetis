...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Right leg injured — cannot drive while in boot, typically week 10-12 earliest",
        },
        {
          text: "Left leg injured — may be possible earlier with automatic car (weeks 4-6)",
        },
        {
          text: "Check insurance — ensure you're covered for driving with injury",
        },
        {
          text: "Get medical clearance — discuss with your clinician",
        },
        {
          text: "Safety first — when in doubt, don't drive",
        },
      ],
    },
    {
          ...
          content: [
            {
              ...
              items: [
                {
                  text: "I have medical clearance from my clinician",
                },
                {
                  text: "My insurance company has confirmed coverage",
                },
                {
                  text: "I can operate all pedals safely and comfortably",
                },
                {
                  text: "I can perform an emergency stop",
                },
                {
                  text: "I am not taking medications that impair driving",
                },
                {
                  text: "I am not in significant pain that would distract me",
                },
                {
                  text: "I feel alert and able to concentrate",
                },
                {
                  text: "My boot (if still wearing) does not interfere with pedals",
                },
              ],
            },
          ],
