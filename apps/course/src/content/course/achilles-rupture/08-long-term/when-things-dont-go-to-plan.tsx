...
export const metadata = {
  ...
  description: "Not progressing, tendon elongation, and when to seek further opinion",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Assess your progress honestly — where are you vs where you should be?",
        },
        {
          text: "Talk to your physio — they can assess and guide next steps",
        },
        {
          text: "Consider further opinion — if concerns persist, seek specialist opinion",
        },
        {
          text: "Don't give up — setbacks happen, but recovery is still possible",
        },
        {
          text: "Be patient — recovery takes time, progress isn't always linear",
        },
        {
          text: "Focus on what you can control — exercises, consistency, following guidance",
        },
      ],
    },
    {
