...
export const metadata = {
  ...
  description: "Aircast vs VACOped, understanding how boots work, and boot basics",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Understand your boot type — Aircast (wedges) or VACOped (hinge)",
        },
        {
          text: "Know your starting position — maximum angle with all wedges in or hinge locked",
        },
        {
          text: "Learn how the angle system works — both boots achieve the same goal differently",
        },
        {
          text: "Check boot fit — detailed fitting guidance in the next lesson",
        },
        {
          text: "Follow your protocol — progression details covered soon",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            {
              title: "Aircast boot — wedge insoles under the heel",
              content: [
                {
                  type: "text",
                  content:
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          description: "Fitting, straps, padding, maintenance, and preventing problems",
          variant: "highlight",
          content: [
            {
              type: "text",
            ...
            {
              type: "text",
              content: "→ Detailed fitting guidance in the next lesson",
            },
          ],
        },
        {
          ...
          content: [
            ...
            {
              type: "text",
              content: "→ Protocol details covered in an upcoming lesson",
            },
          ],
        },
      ],
