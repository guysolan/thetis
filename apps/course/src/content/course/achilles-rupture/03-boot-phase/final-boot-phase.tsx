...
export const metadata = {
  ...
  description: "Remodelling stage, tendon strength, and removing final wedges",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Continue following your protocol — don't rush ahead even if you feel ready",
        },
        {
          text: "Remove final wedges (Aircast) or adjust hinge (VACOped) gradually — follow your clinician's schedule exactly",
        },
        {
          text: "Monitor tendon strength — you'll feel it getting stronger",
        },
        {
          text: "Prepare for boot removal — start thinking about what comes next",
        },
        {
          text: "Stay patient — the final weeks matter as much as the first",
        },
      ],
    },
    {
    ...
    {
      type: "section",
      title: "Understanding Stage 2 and Stage 3: What Comes After Boot Removal",
      content: [
        {
          type: "text",
          content:
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "Here's what happens when you transition from boot to walking:",
            },
            {
              type: "list",
              style: "bullet",
