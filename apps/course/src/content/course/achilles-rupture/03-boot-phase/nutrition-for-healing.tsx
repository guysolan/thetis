...
export const metadata = {
  ...
  description: "Evidence-based nutrition guidance for Achilles rupture recovery",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Eat a balanced diet — include fruits, vegetables, whole grains, and protein sources",
        },
        {
          text: "Include vitamin C — essential for collagen (from fruits and vegetables)",
        },
        {
          text: "Stay hydrated — drink water throughout the day",
        },
        {
          text: "Don't overthink it — focus on variety rather than specific targets",
        },
      ],
    },
    {
