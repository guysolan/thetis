...
export const metadata = {
  ...
  description: "When and how to remove wedges, angle progression, and what to expect",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Check with your clinician before removing any wedges — timing varies by protocol",
        },
        {
          text: "Remove wedges gradually, one at a time, usually starting around week 4-5",
        },
        {
          text: "Watch for increased pain or swelling — these are warning signs to slow down",
        },
        {
          text: "Keep your foot protected in the boot 24/7 — removing wedges doesn't mean removing protection",
        },
        {
          text: "Follow your specific protocol — some remove wedges weekly, others every 2 weeks",
        },
      ],
    },
    {
