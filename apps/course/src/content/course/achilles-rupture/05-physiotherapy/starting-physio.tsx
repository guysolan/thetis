...
export const metadata = {
  ...
  description: "First session expectations, early goals, and the importance of consistency",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Attend physio — bring questions, your boot if still wearing it, comfortable clothes",
        },
        {
          text: "Understand Stage 2 goals — know what you're working toward (Walking normally, basic balance, early strength)",
        },
        {
          text: "Set up a home exercise routine — consistency at home matters more than clinic visits",
        },
        {
          text: "Track your progress — note what you can do, what's challenging, what's improving",
        },
        {
          text: "Communicate openly — tell your physio about pain, concerns, limitations",
        },
        {
          text: "Be patient — progress happens gradually, not overnight",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "After the assessment, your physio will explain your personalized plan:",
            },
            {
              type: "list",
              style: "bullet",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          caption: "Stage 2 goals: what you're working toward in the Transition stage",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          description: "Why regular practice beats occasional perfection.",
          variant: "highlight",
          content: [
            {
              type: "list",
