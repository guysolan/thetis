...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Focus on heel-to-toe pattern — land on your heel first, then roll through to your toes",
        },
        {
          text: "Work on step length — take normal-sized steps, not tiny shuffling steps",
        },
        {
          text: "Practice symmetry — make both legs work equally",
        },
        {
          text: "Use [heel lifts](/standard/post-boot-period) — 0.5-1cm heel lift helps protect your tendon initially",
        },
        {
          text: "Practice daily — short walks focusing on form, not distance",
        },
        {
          text: "Be patient — correcting your gait takes time and practice",
        },
      ],
    },
    {
