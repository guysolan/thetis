...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Master the basics — focus on proper form before adding difficulty",
        },
        {
          text: "Do exercises consistently — daily practice matters more than perfect sessions",
        },
        {
          text: "Track your progress — note how many reps, how much weight, what feels challenging",
        },
        {
          text: "Listen to your body — some discomfort is normal, severe pain is not",
        },
        {
          text: "Progress gradually — don't rush ahead, follow your physio's guidance",
        },
        {
          text: "Ask questions — if unsure about form or progression, ask your physio",
        },
      ],
    },
    {
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              caption: "Seated calf raise: correct form with foot pointed down",
            },
            {
              type: "card",
              title: "Advanced Testing: ISOM Overcoming",
              description: "How physios measure your strength precisely.",
              variant: "muted",
              content: [
                {
                  type: "text",
                ...
                {
                  type: "text",
                  content: "**Target goals (with bent knee):**",
                },
                {
                  type: "list",
                  style: "bullet",
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              caption: "Standing two-foot calf raise: correct form with both feet together",
            },
            {
              type: "card",
              title: "Advanced Testing: ISOM Yielding",
              description: "How physios test your holding strength.",
              variant: "muted",
              content: [
                {
                  type: "text",
                ...
                {
                  type: "text",
                  content: "**Target goals (with straight knee):**",
                },
                {
                  type: "list",
                  style: "bullet",
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              caption: "Towel stretch: gentle flexibility exercise",
            },
            {
              type: "alert",
              variant: "warning",
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              caption: "Resistance band exercise: building strength with controlled resistance",
            },
            {
              type: "tip",
              title: "Product recommendation: TheraBand Resistance Bands",
              content:
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              caption: "Balance training: rebuilding control and coordination",
            },
            {
              type: "alert",
              variant: "info",
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**The mistake:** Only doing the exercises you like or skipping days.",
            },
            {
              type: "text",
              content:
