                    ...
                    content: [
                        {
                            type: "text",
                            content:
                                "As we covered in Week 8, protected walking techniques help prevent elongation — the biggest risk after boot removal. When you first remove your boot, your tendon is still vulnerable. Key techniques include using a heel wedge (1.2cm), taking shorter steps, using partial weight-bearing if limping, and gradually progressing as your strength improves. See Week 8 for the full details and infographic.",
                        },
                    ],
                },
            ],
