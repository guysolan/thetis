...
export const metadata = {
    slug: "week-10-day-4-boot-transition",
                ...
                },
                {
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            style: "bullet",
                            items: [
                                "**Heel wedge (1.2cm)**: Use a heel lift in your shoe to reduce tendon stretch",
                                "**Reduced step length**: Take shorter steps than normal to reduce force through your tendon",
                                "**Partial weight-bearing if limping**: If you're limping significantly, use crutches or reduce weight on the injured foot",
                        ...
                        },
                        {
                            type: "text",
                            content:
                                "Your physiotherapist will guide you on when to progress these techniques. Don't rush — protecting your tendon now prevents problems later.",
                        },
                    ],
                },
            ],
