...
import BootForceComparison from "../../../assets/boot-force-comparison-v2.png";
            ...
            content: [
                {
                    type: "text",
                    content:
                        "Your boot holds your foot pointed down (plantarflexed) to keep the torn tendon ends close together. As the tendon heals, you gradually reduce this angle until your foot reaches a neutral position. Think of it like gradually lowering a platform.",
                },
                {
                    type: "card",
