...
export const metadata = {
  ...
  description: "Pain-free walking, 25+ heel raises, balance tests, and stairs",
  status: "drafting" as const,
};

export const faqs: FAQItem[] = [
  {
    question: "Is it normal to not reach all milestones at Week 20?",
    answer:
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Test your Stage 3 milestones — pain-free walking, 25+ heel raises, balance, stairs",
        },
        {
          text: "Be honest with yourself — know where you are, not where you want to be",
        },
        {
          text: "Work on gaps — if you haven't reached a milestone, focus on that area",
        },
        {
          text: "Celebrate progress — acknowledge how far you've come",
        },
        {
          text: "Talk to your physio — they'll assess your milestones and guide next steps",
        },
        {
          text: "Be patient — milestones take time, everyone progresses differently",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          caption: "The 4 key functional milestones: what you're working toward",
        },
        {
          type: "card",
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**What it means:** You can balance on your injured leg confidently.",
            },
            {
              type: "text",
              content: "**How to test:**",
