...
export const metadata = {
  ...
  description: "Swimming, stationary bike, elliptical, and walking as exercise",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Start with low-impact options — swimming, bike, elliptical are safest",
        },
        {
          text: "Avoid high-impact activities — no running, jumping, or high-impact sports yet",
        },
        {
        ...
        {
          text: "Check with your physio — make sure you're cleared for cardio",
        },
        {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**Why it's safe:** You're already walking, now you can use it for fitness.",
            },
            {
              type: "text",
              content: "**How to do it:**",
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**When to start:** Week 10-12 (with approval)",
            },
            {
              type: "list",
              style: "bullet",
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**When to start:** Week 12-14 (once comfortable with pool walking)",
            },
            {
              type: "list",
              style: "bullet",
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**When to start:** Week 16-20 (with flotation belt)",
            },
            {
              type: "list",
              style: "bullet",
    ...
    },
    {
      ...
      content: [
        {
          type: "text",
          content: "Start gently and progress gradually. Here's a typical progression plan:",
        },
        {
          type: "image",
