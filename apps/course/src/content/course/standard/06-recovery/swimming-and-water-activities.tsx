...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Wait until wounds are healed — surgical wounds must be fully closed",
        },
        {
          text: "Get specialist approval — check with your clinician first",
        },
        {
          text: "Start gently — walking in pool, then gentle swimming",
        },
        {
          text: "Avoid push-offs — don't push off from wall with injured leg initially",
        },
        {
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              type: "list",
              style: "bullet",
              items: ["**Duration:** Start with 10-15 minutes, build to 20-30 minutes"],
            },
          ],
        },
        {
