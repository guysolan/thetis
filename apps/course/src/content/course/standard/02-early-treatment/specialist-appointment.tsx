...
export const metadata = {
  ...
  description: "What to expect at orthopaedics, physical examination, and imaging",
  status: "drafting" as const,
};

export const faqs: FAQItem[] = [
  {
    question: "What if my appointment is delayed beyond 2 weeks?",
    answer:
  ...
  {
    question: "Do I need to decide on surgery at this appointment?",
    answer:
  ...
  {
    question: "What if the specialist recommends something different from what A&E said?",
    answer:
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Write down your questions (see list below) — you'll forget them in the room",
        },
        {
          text: "Bring someone if possible — two sets of ears catch more information",
        },
        {
          text: "Wear loose trousers or shorts (they'll need to examine your leg)",
        },
        {
          text: "Arrive early — clinics can run behind, and rushing adds stress",
        },
        {
          text: "Bring your current medications list (including any blood thinners)",
        },
        {
          text: "Have your phone ready to take notes or record (ask permission first)",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              title: "2. Physical examination — the hands-on tests",
              content: [
                {
                  type: "text",
                  content:
                  ...
                  content: [
                    {
                      ...
                      rows: [
                        ["Speed", "Often same-day", "Usually scheduled separately"],
                        ["Cost", "Lower", "Higher"],
                        [
                          "What it shows",
