...
export const metadata = {
  ...
  description: "Understanding your options, UKSTAR trial findings, and making your decision",
...
export const faqs: FAQItem[] = [
  ...
  {
    question: "What if my specialist recommends one thing but I prefer the other?",
    answer:
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Understand both treatment options (surgery vs non-surgical)",
        },
        {
          text: "Discuss your options with your specialist — ask questions",
        },
        {
          text: "Consider your activity level, goals, and personal circumstances",
        },
        {
          text: "Remember: you don't have to decide everything today — it's OK to ask for time",
        },
        {
          text: "Keep protecting the tendon 24/7 regardless of which path you choose",
        },
      ],
    },
    {
      ...
      caption: "Treatment outcomes: both approaches work well for most people",
    },
    {
      type: "section",
          ...
          items: [
            ...
            },
            {
              ...
              content: [
                {
                  type: "text",
                  content: "The recovery timeline is very similar to non-surgical treatment:",
                },
                {
                  type: "list",
                  style: "bullet",
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              title: "Potential benefits of non-surgical treatment",
              content: [
                {
                  type: "list",
                  style: "bullet",
