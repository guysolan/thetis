...
export const metadata = {
  ...
  description: "Walk-jog progression, proper technique, surface selection, and avoiding pitfalls",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Meet Stage 3 exit criteria first — 25+ heel raises, pain-free walking, good balance",
        },
        {
          text: "Start with walk-jog progression — gradual transition from walking to running",
        },
        {
          text: "Choose safe surfaces — flat, soft surfaces initially",
        },
        {
          text: "Focus on proper technique — heel-to-toe pattern, short strides",
        },
        {
          text: "Progress gradually — don't rush, follow progression plan",
        },
        {
          text: "Listen to your body — stop if you have pain or concerns",
        },
      ],
    },
    {
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              caption: "Proper running form: controlled midfoot strike with short, light strides",
            },
          ],
        },
      ],
      ...
      content: [
        {
          ...
          content: [
            ...
            {
              type: "text",
              content: "**Why it's dangerous:** Increases re-rupture risk significantly.",
            },
            {
              type: "text",
              content: "**The fix:** Wait until you meet all criteria and get physio clearance.",
            },
          ],
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**The mistake:** Jumping from walk-jog to long runs too quickly.",
            },
            {
              type: "text",
              content: "**Why it's dangerous:** Sudden increases stress your tendon.",
            },
            {
              type: "text",
              content: "**The fix:** Follow progression plan, increase gradually (10% rule).",
            },
          ],
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**The mistake:** Running through pain because you think it's normal.",
            },
            {
              type: "text",
              content:
            ...
            {
              type: "text",
              content: "**The fix:** Stop if you have pain, tell your physio, don't push through.",
            },
          ],
        },
      ],
