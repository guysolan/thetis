...
export const metadata = {
  ...
  description: "Criteria, process, and timeline for returning to your sport safely",
...
export const faqs: FAQItem[] = [
  ...
  {
    question: "Should I stop strengthening exercises when I return to sport?",
    answer:
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Meet return criteria — 85% symmetry in strength, hopping, jumping",
        },
        {
          text: "Understand the return process — modified practice → full participation → pre-injury level",
        },
        {
          text: "Assess psychological readiness — confidence is as important as physical readiness",
        },
        {
          text: "Start gradually — begin with modified practice and sport-specific drills",
        },
        {
          text: "Continue strengthening — don't stop exercises just because you're returning to sport",
        },
        {
          text: "Be realistic — return takes several months, 70-80% return to play rates",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**What it involves:** Sport-specific drills and modified practice sessions",
            },
            {
              type: "list",
              style: "bullet",
        ...
        },
        {
          ...
          description: "Returning to normal practice and competition.",
          variant: "default",
          content: [
            {
              type: "text",
              content: "**What it involves:** Full participation in practice and competition",
            },
            {
              type: "list",
              style: "bullet",
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**What it involves:** Performing at or above your pre-injury level",
            },
            {
              type: "list",
              style: "bullet",
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**Prevents re-injury:** Ongoing strength reduces re-rupture risk",
            },
            {
              type: "text",
              content:
            ...
            {
              type: "text",
              content: "**Supports performance:** Stronger muscles support better performance",
            },
            {
              type: "text",
              content:
