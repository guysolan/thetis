...
export const metadata = {
  ...
  description: "When to start, progression from pogo jumps to sport-specific training",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Meet criteria first — [25+ heel raises](/standard/progressive-strengthening), comfortable running, physio clearance",
        },
        {
          text: "Start with simple jumps — pogo jumps, two-foot jumps",
        },
        {
          text: "Progress gradually — from simple to complex movements",
        },
        {
          text: "Focus on landing — proper landing technique is crucial",
        },
        {
          text: "Listen to your body — stop if you have pain or concerns",
        },
        {
          text: "Follow your physio's guidance — they'll guide progression",
        },
      ],
    },
    {
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              caption: "Pogo jumps: small, controlled bounces on balls of feet",
            },
          ],
        },
        {
