...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Wait until wounds are fully healed — usually 2-3 weeks after surgery or boot removal",
        },
        {
          text: "Start gently — scar massage should be gentle, not painful",
        },
        {
          text: "Use bio-oil or moisturizer — helps keep scar tissue supple",
        },
        {
          text: "Be patient — scars take months to mature",
        },
        {
          text: "Protect from sun — use sunscreen on scars",
        },
      ],
    },
    {
