...
export const metadata = {
  ...
  description: "Stiffness, swelling, and why you shouldn't stretch aggressively",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Manage stiffness gently — use gentle movements and heat, not aggressive stretching",
        },
        {
          text: "Control swelling — elevate when resting, use ice if needed, compression if recommended",
        },
        {
          text: "Avoid aggressive stretching — your tendon is still healing, aggressive stretching can cause elongation",
        },
        {
          text: "Stay active — gentle movement helps with stiffness and swelling",
        },
        {
          text: "Be patient — stiffness and swelling are normal, they'll improve gradually",
        },
        {
          text: "Follow your physio's guidance — they know what's safe for your stage",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: "text",
              content: "**Normal healing** — this is part of the normal recovery process.",
            },
          ],
        },
        {
