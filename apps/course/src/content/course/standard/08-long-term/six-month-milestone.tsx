...
export const metadata = {
  ...
  description: "Where your tendon is now, return-to-sport criteria, and psychological readiness",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Assess your progress — where are you now vs where you started?",
        },
        {
          text: "Understand return-to-sport criteria — know what you need to achieve",
        },
        {
          text: "Assess psychological readiness — are you mentally ready to return?",
        },
        {
          text: "Continue strengthening — don't stop just because you're at 6 months",
        },
        {
          text: "Be realistic — full return to sport takes time, don't rush",
        },
        {
          text: "Talk to your physio — they'll assess your readiness and guide next steps",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          caption: "Where your tendon is now at 6 months: healing status and what's normal",
        },
        {
          type: "card",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          caption: "Return-to-sport criteria: what you need to achieve before returning to sport",
        },
        {
          type: "card",
        ...
        },
        {
          ...
          description: "For comprehensive criteria and return process.",
          variant: "default",
          content: [
            {
              type: "text",
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**Gradual exposure** — start with low-risk activities, build up gradually",
            },
            {
              type: "text",
              content: "**Build strength** — feeling strong builds confidence",
            },
            {
              type: "text",
              content: "**Talk to your physio** — they can help with confidence building",
            },
            {
              type: "text",
              content:
