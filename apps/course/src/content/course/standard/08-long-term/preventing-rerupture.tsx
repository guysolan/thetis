...
export const metadata = {
  ...
  description: "Risk factors, ongoing strengthening, warm-up protocols, and warning signs",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Continue strengthening — ongoing strength is crucial for prevention",
        },
        {
        ...
        {
          text: "Progress gradually — don't rush back to high-risk activities",
        },
        {
          text: "Listen to your body — pain and fatigue are warning signs",
        },
        {
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: "text",
              content: "**Sport-specific movements:** — movements specific to your sport",
            },
          ],
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**Increases blood flow** — warm muscles have better blood supply",
            },
            {
              type: "text",
              content: "**Improves flexibility** — warm muscles are more flexible",
            },
            {
              type: "text",
              content: "**Prepares nervous system** — your brain and muscles communicate better",
            },
            {
              type: "text",
              content: "**Reduces injury risk** — proper warm-up significantly reduces injury risk",
            },
          ],
        },
      ],
