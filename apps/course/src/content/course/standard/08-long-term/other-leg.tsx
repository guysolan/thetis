...
export const metadata = {
  ...
  description: "Higher risk of rupture, but only 5% — rehab should include both legs",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Strengthen both calves — don't neglect the uninjured leg",
        },
        {
          text: "Warm up both sides — before activity, always",
        },
        {
          text: "Include both legs in your rehab — balanced strength supports good movement",
        },
        {
          text: "Don't over-worry — 5% risk means 95% don't rupture the other",
        },
      ],
    },
    {
