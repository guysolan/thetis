...
export const metadata = {
  ...
  description: "Your tendon will always be different, managing expectations, and long-term care",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Accept permanent changes — your tendon will always be different, and that's okay",
        },
        {
          text: "Maintain strength long-term — ongoing strength is crucial",
        },
        {
          text: "Manage expectations — full recovery takes time, be realistic",
        },
        {
          text: "Continue prevention — warm-ups, gradual progression, listening to your body",
        },
        {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          description:
            "Maintain strength long-term. See [Progressive Strengthening](/standard/progressive-strengthening) for exercise guidance.",
          variant: "highlight",
          content: [
            {
              type: "list",
