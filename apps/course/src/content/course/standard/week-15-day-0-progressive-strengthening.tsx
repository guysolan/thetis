...
export const metadata = {
    slug: "week-15-day-0-progressive-strengthening",
    ...
    blocks: [
        ...
        },
        {
            ...
            items: [
                {
                    text:
                        "Master single-leg heel raises — work toward 15+ reps, this is the gold standard",
                },
                {
                    text:
            ...
            content: [
                {
                    type: "text",
                    content:
                        "Single-leg heel raises are the **gold standard test** for Phase 2. Being able to do 15+ repetitions shows your calf is strong enough for normal walking and daily activities. Think of it as **passing a driving test** — once you can do it, you're ready for the next phase.",
                },
                {
                    type: "card",
                    ...
                    content: [
                        {
                            type: "text",
                            content:
                                "**15+ reps indicates strength** — your calf can produce enough force for normal function. This is the target that shows you're ready for Phase 3.",
                        },
                        {
                            type: "text",
                            content:
                                "**It's a functional test** — if you can do 15+ single-leg heel raises, your calf is strong enough for walking, stairs, and daily activities.",
                        },
                        {
                            type: "text",
                            content:
            ...
            content: [
                {
                    ...
                    style: "bullet",
                    items: [
                        "**This week:** Focus on progressive strengthening — building toward 15+ single-leg heel raises",
            ...
            content: [
                {
                    ...
                    style: "bullet",
                    items: [
                        "**15+ single-leg heel raises is the goal** — this is the gold standard for Phase 2",
