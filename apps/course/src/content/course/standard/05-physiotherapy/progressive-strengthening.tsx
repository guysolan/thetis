...
export const metadata = {
  ...
  description: "Single-leg heel raises, seated calf strength, and resistance training",
  status: "drafting" as const,
};

export const faqs: FAQItem[] = [
  {
    question: "How long until I can do 15 single-leg heel raises?",
    answer:
  ...
  {
    question: "What if I can only do 1-2 single-leg heel raises?",
    answer:
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Master single-leg heel raises — work toward 15 reps on flat ground, this is the Stage 3 mid-point target",
        },
        {
          text: "Build seated calf strength — aim for 90% LSI (injured leg vs healthy leg) or bodyweight targets (1.4x isometric, 1.2x isotonic)",
        },
        {
          text: "Progress resistance training — gradually increase weight and difficulty",
        },
        {
          text: "Track your progress — note reps, weight, how exercises feel",
        },
        {
          text: "Follow progression principles — don't rush ahead, progress systematically",
        },
        {
          text: "Communicate with your physio — tell them about progress and challenges",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          description: "Building from double-leg to weighted single-leg.",
          variant: "highlight",
          content: [
            {
              type: "text",
            ...
            },
            {
              ...
              caption: "Heel raise progression: double-leg to single-leg on flat ground",
            },
            {
              type: "text",
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              ...
              caption: "Isometric holds: progressing from double-leg to single-leg",
            },
          ],
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "**Too easy** — if you can do 20+ reps easily, it's time to add difficulty.",
            },
            {
              type: "text",
              content:
      ...
      content: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: "text",
              content: "**Target goals (with bent knee, seated, foot pointed down):**",
            },
            {
              type: "list",
              style: "bullet",
