...
export const metadata = {
  ...
  description: "The proliferative stage, tendon length, and why patience matters",
...
export const content: SectionContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        {
          text: "Keep following your boot protocol — don't rush wedge removal",
        },
        {
          text: "Continue elevation when resting — swelling slows healing",
        },
        {
          text: "Be patient — your tendon is actively healing, even if you can't see it",
        },
        {
          text: "Don't test your tendon — no stretching, no 'seeing if I can stand on tiptoe'",
        },
        {
          text: "Report any concerns to your clinician — but know what's normal vs urgent",
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          caption: "Biological healing timeline: inflammation → new tissue growth → strengthening",
        },
        {
          type: "card",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          description: "What clinicians mean when they talk about gap size.",
          variant: "default",
          content: [
            {
              type: "text",
