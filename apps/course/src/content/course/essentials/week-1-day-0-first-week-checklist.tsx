...
import NormalVsUrgentSymptoms from "../../../assets/normal-vs-urgent-symptoms.png";

export const metadata = {
    slug: "week-1-day-0-first-week-checklist",
...
export const content: SectionContent = {
    ...
    blocks: [
        ...
        {
            type: "image",
            src: NormalVsUrgentSymptoms,
            alt: "Six-panel comic showing normal symptoms (bruising, swelling, disrupted sleep) versus urgent red flags (calf pain, chest pain, pale toes) in Week 1 after Achilles rupture",
            caption: "Week 1: Normal vs Urgent — when in doubt, get checked",
        },
        {
            type: "section",
