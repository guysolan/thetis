...
export const WEBSITE_URL = import.meta.env.VITE_WEBSITE_URL || "https://thetismedical.com";

export const COURSE_URL = import.meta.env.VITE_COURSE_URL || "https://guide.thetismedical.com";
