...
Requires the knowledge base migration applied and `bun run sync` executed in `packages/knowledge-corpus`. The Edge Functions need `OPENAI_API_KEY` set as a Supabase secret (used for embeddings and chat).
