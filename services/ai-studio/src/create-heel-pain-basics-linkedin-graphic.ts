...
const outputPath = path.join(
    process.cwd(),
    "output",
    "pf-heel-pain-basics-matter-most-linkedin-v1.png",
);
    ...
    const cards = [
        {
            num: "1",
            title: "FOUNDATION",
            body1: "Daily exercises, load management,",
            body2: "and the core treatments that help most",
            y: 236,
            icon: iconFoundation,
        },
        {
            ...
            body1: "Additional options if a thorough trial",
            body2: "of Level 1 hasn't improved enough",
            y: 430,
            icon: iconFurther,
        },
        {
            num: "3",
            title: "SURGERY",
            body1: "Only for the small number who still",
            body2: "have significant symptoms after Level 1–2",
            y: 624,
            icon: iconSurgery,
        },
    ];
...
<svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
  ...
  ${text("HEEL PAIN RECOVERY", 540, 52, "eyebrow")}
  ${text("WHY THE BASICS MATTER MOST", 540, 110, "headline")}
  ${text("Recovery starts with the fundamentals — not shortcuts", 540, 160, "subhead")}

  ${cardSvgs}

  <!-- Footer -->
  <rect x="48" y="820" width="984" height="200" rx="18" fill="#d7eadf" stroke="#0c4a36" stroke-width="3"/>
  ${text("Don't skip the foundation for a quick fix.", 540, 880, "footerTitle")}
  ${text("Advanced treatments work best after the basics", 540, 928, "footerBody")}
  ${text("have been followed consistently long enough.", 540, 968, "footerBody")}
</svg>`;
