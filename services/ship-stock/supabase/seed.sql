...
VALUES
    (1, 'Company', '12345678', 'GB123456789', 1),
...
VALUES
    (1, 'Park House', 'Stilemans', 'Hascombe Road', 'Godalming', NULL, 'United Kingdom', 'GU8 4AB', TRUE, 1, TRUE, FALSE),
(2, 'MPD', 'Unit 4', 'Commerce Business Centre, Commerce Close', 'Westbury', NULL, 'United Kingdom', 'BA13 4LS', TRUE, 2, TRUE, TRUE),
(3, 'Thetis Medical', 'C/O The Accountancy Partnership', 'Suite 5, 5th Floor, City Reach, 5 Greenwich View Place', 'London', NULL, 'United Kingdom', 'E14 9NN', FALSE, 1, FALSE, TRUE),
...
VALUES
    (3, 'Assemble Large Splint', 8.50, 'service', 1),
...
VALUES
    (5, 'Instruction Leaflet', 0.20, 'part', 'TM-PART-001', 'United Kingdom', 1),
...
VALUES
    (1, 'Achilles Tendon Rupture Night Splint - Large', 89.99, 'product', 902110, 'TM-ATRS-LL', 'United Kingdom', 1),
...
VALUES
    (10, 'Box of 50 Large Splints', 4499.50, 'package', 60.00, 40.00, 35.00, 10.00, 'TM-ATRS-L-50', 'United Kingdom', 1),
...
VALUES
    ('Guy Stevenson', 'guy@thetismedical.com', '+44 7700 900077', 1, TRUE),
