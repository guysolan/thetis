...
3. **Course Products Created**
   - Standard Course product ID: `9846187786568`
   - Premium Course product ID: `9846188081480`
   - Note: Update these IDs in `index.ts` to match your actual Shopify product IDs
