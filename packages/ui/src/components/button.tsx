...
const buttonVariants = cva(
  "inline-flex justify-center items-center disabled:opacity-50 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ring-offset-background focus-visible:ring-offset-2 font-semibold transition-colors cursor-pointer disabled:pointer-events-none",
  {
    variants: {
      variant: {
