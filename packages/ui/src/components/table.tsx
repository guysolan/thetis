...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "dark:text-neutral-200 p-2 align-middle [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-4 text-neutral-500 dark:text-neutral-400 text-sm", className)}
    {...props}
  />
));
