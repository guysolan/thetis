  ...
  public: {
    Tables: {
      ...
      orders_text_blocks: {
        ...
        Relationships: [
          {
            foreignKeyName: "orders_text_blocks_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "orders_text_blocks_text_block_id_fkey"
    ...
    Functions: {
      ...
      upsert_order: {
        Args: {
          ...
          in_currency?: Database["public"]["Enums"]["currency_type"]
          in_carriage?: number
          in_reason_for_export?: string
          in_shipment_number?: string
          in_airwaybill?: string
          in_mode_of_transport?: string
          in_incoterms?: string
          in_unit_of_measurement?: string
          in_company_id?: number
        }
        Returns: {
          order_id: number
