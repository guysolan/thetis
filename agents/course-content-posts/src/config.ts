...
export const config = {
  ...
  contentCalendarDbId:
    process.env.NOTION_CONTENT_CALENDAR_DB_ID || "2415c2ea829a8001983be38e0ccf93df",
  courseContentPath: join(ROOT, "apps/course/src/content/course/standard"),
  ...
  clinicalPositionsPath: join(ROOT, ".cursor/rules/achilles-clinical-positions.mdc"),
