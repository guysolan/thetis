-- Make currency nullable and set carriage default to 0
ALTER TABLE orders
    ALTER COLUMN currency DROP NOT NULL,
    ALTER COLUMN carriage SET DEFAULT 0;

-- First update any existing orders with type 'build'
UPDATE
    orders
SET
    order_type = 'purchase'
...
-- Create a new enum type without 'build'
CREATE TYPE order_type_new AS enum(
    'purchase',
    'sale',
    'shipment',
    'stocktake'
